...
const routes = [
    ...
    // ── GAP System ────────────────────────────────────
    {
        ...
        children: [
            ...
            },
            {
                path: "schedule",
                name: "staffSchedule",
                component: () => import("@/views/gap/staff/SchedulingPage.vue"),
            ...
            //แบบกลุ่ม
            {
                ...
                name: "staffGroupNewApplicationForm",
                component: () => import("@/views/gap/staff/group/StaffNewApplicationPage.vue"),
                meta: { title: "ยื่นคำขอใหม่" },
            },
            {
                path: "group/applications",
                name: "staffGroupApplicationList",
                component: () => import("@/views/gap/staff/group/ApplicationListPage.vue"),
                meta: { title: "รายการคำขอ" },
            },
            {
                path: "group/applications/:id",
                name: "staffGroupApplicationDetail",
                component: () => import("@/views/gap/staff/group/ApplicationDetailPage.vue"),
                meta: { title: "รายละเอียดคำขอ GAP" },
            },
            {
                path: "group/schedule",
                name: "staffGroupSchedule",
                component: () => import("@/views/gap/staff/group/SchedulingPage.vue"),
                meta: { title: "นัดหมายตรวจแปลง", statusFilter: "scheduling" },
            },
            {
                path: "group/inspection-results",
                name: "staffGroupInspectionResults",
                component: () => import("@/views/gap/staff/group/InspectionResultsListPage.vue"),
                meta: { title: "บันทึกผลตรวจแปลง", statusFilter: "inspected" },
            },
            {
                path: "group/inspection-results/:id",
                name: "staffGroupInspectionResultDetail",
                component: () => import("@/views/gap/staff/group/InspectionResultsDetailPage.vue"),
                meta: { title: "รายละเอียดผลตรวจแปลง" },
            },
            {
                path: "group/propose-cc",
                name: "staffGroupProposeCC",
                component: () => import("@/views/gap/staff/group/ProposeListPage.vue"),
                meta: { title: "เสนอแปลงต่อ CC", statusFilter: "pending_cc" },
            },
            {
                path: "group/cc-results",
                name: "staffGroupCCResults",
                component: () => import("@/views/gap/staff/group/ResultsCCPage.vue"),
                meta: { title: "บันทึกครั้งที่เสนอ CC", statusFilter: "cc_reviewing" },
            },
            {
                path: "group/cc-saveresults",
                name: "staffGroupSaveCCResults",
                component: () => import("@/views/gap/staff/group/ResultsSaveCCPage.vue"),
                meta: { title: "บันทึกผลจาก CC", statusFilter: "cc_savereviewing" },
            },
            {
                path: "group/previsit-appointment",
                name: "staffGroupPrevisitAppointment",
                component: () => import("@/views/gap/staff/group/PrevisitAppointmentPage.vue"),
                meta: { title: "นัดหมายการตรวจเยี่ยม Previsit" },
            },
            {
                path: "group/previsit-results",
                name: "staffGroupPrevisitResults",
    ...
    // ── ORG System ────────────────────────────────────
    {
        ...
        children: [
            ...
            {
                path: "applications/new/group",
                name: "ORGUserApplicationTypeGroup",
                component: () => import("@/views/org/user/ApplicationTypeGroupPage.vue"),
                meta: { title: "เลือกประเภทใบรับรอง" },
            },
            {
                path: "applications/new/individual",
            ...
            {
                path: "applications/new/group/:subtype",
                name: "ORGUserNewApplicationGroup",
                component: () => import("@/views/org/user/forms/GroupFormForGroupPage.vue"),
                meta: { title: "ยื่นคำขอใหม่ รายกลุ่ม" },
            },
            {
                path: "applications/new/group/:subtype",
            ...
            {
                path: "applications/new/groupedit/:subtype",
                name: "ORGUserNewApplicationEdit",
                component: () => import("@/views/org/user/forms/EditGroupFormPage.vue"),
                meta: { title: "แบบขอแก้ไขเปลี่ยนแปลงข้อมูลใบรับรอง F-5" },
            },
            {
                path: "applications/new/groupcancel/:subtype",
                name: "ORGUserNewApplicationCancel",
                component: () => import("@/views/org/user/forms/CancelGroupFormPage.vue"),
                meta: { title: "แบบคำขอยกเลิกการรับรอง" },
            },
            {
                path: "applications/new/amendment",
            ...
            {
                path: "applications/edit/:id",
                name: "ORGUserEditApplication",
                component: () => import("@/views/org/user/ApplicationEditPage.vue"),
                meta: { title: "แก้ไขคำขอ ORG" },
            },
            {
                path: "applications/cancel/:id",
                name: "ORGUserCancelApplication",
                component: () => import("@/views/org/user/ApplicationCancelPage.vue"),
                meta: { title: "ยกเลิกคำขอ ORG" },
            },
        ],
    },
    {
        ...
        children: [
            ...
            {
                path: "inspection-results",
                name: "ORGStaffInspectionResults",
                component: () => import("@/views/org/staff/InspectionResultsListPage.vue"),
                meta: { title: "บันทึกผลตรวจแปลง", statusFilter: "inspected" },
            },
            {
                path: "inspection-results/:id",
                name: "ORGStaffInspectionResultDetail",
                component: () => import("@/views/org/staff/InspectionResultsDetailPage.vue"),
                meta: { title: "รายละเอียดผลตรวจแปลง" },
            },
            {
                path: "propose-cc",
                name: "ORGStaffProposeCC",
                component: () => import("@/views/org/staff/ProposeListPage.vue"),
                meta: { title: "เสนอแปลงต่อ CC", statusFilter: "pending_cc" },
            },
            {
                path: "cc-results",
                name: "ORGStaffCCResults",
                component: () => import("@/views/org/staff/ResultsCCPage.vue"),
                meta: { title: "บันทึกครั้งที่เสนอ CC", statusFilter: "cc_reviewing" },
            },
            {
                path: "cc-saveresults",
                name: "ORGStaffSaveCCResults",
                component: () => import("@/views/org/staff/ResultsSaveCCPage.vue"),
                meta: { title: "บันทึกผลจาก CC", statusFilter: "cc_savereviewing" },
            },
            {
                path: "cc-saveresults/:id",
                name: "ORGStaffSaveCCResultDetail",
            ...
            {
                path: "group/applications/new",
                name: "ORGStaffGroupNewApplicationForm",
                component: () => import("@/views/org/staff/group/StaffNewApplicationPage.vue"),
                meta: { title: "ยื่นคำขอใหม่" },
            },
            {
                path: "group/applications",
                name: "ORGStaffGroupApplicationList",
                component: () => import("@/views/org/staff/group/ApplicationListPage.vue"),
                meta: { title: "รายการคำขอ" },
            },
            {
                path: "group/applications/:id",
                name: "ORGStaffGroupApplicationDetail",
                component: () => import("@/views/org/staff/group/ApplicationDetailPage.vue"),
                meta: { title: "รายละเอียดคำขอ GAP" },
            },
            {
                path: "group/schedule",
                name: "ORGStaffGroupSchedule",
                component: () => import("@/views/org/staff/group/SchedulingPage.vue"),
                meta: { title: "นัดหมายตรวจแปลง", statusFilter: "scheduling" },
            },
            {
                path: "group/inspection-results",
                name: "ORGStaffGroupInspectionResults",
                component: () => import("@/views/org/staff/group/InspectionResultsListPage.vue"),
                meta: { title: "บันทึกผลตรวจแปลง", statusFilter: "inspected" },
            },
            {
                path: "group/inspection-results/:id",
                name: "ORGStaffGroupInspectionResultDetail",
                component: () => import("@/views/org/staff/group/InspectionResultsDetailPage.vue"),
                meta: { title: "รายละเอียดผลตรวจแปลง" },
            },
            {
                path: "group/propose-cc",
                name: "ORGStaffGroupProposeCC",
                component: () => import("@/views/org/staff/group/ProposeListPage.vue"),
                meta: { title: "เสนอแปลงต่อ CC", statusFilter: "pending_cc" },
            },
            {
                path: "group/cc-results",
                name: "ORGStaffGroupCCResults",
                component: () => import("@/views/org/staff/group/ResultsCCPage.vue"),
                meta: { title: "บันทึกครั้งที่เสนอ CC", statusFilter: "cc_reviewing" },
            },
            {
                path: "group/cc-saveresults",
                name: "ORGStaffGroupSaveCCResults",
                component: () => import("@/views/org/staff/group/ResultsSaveCCPage.vue"),
                meta: { title: "บันทึกผลจาก CC", statusFilter: "cc_savereviewing" },
            },
            {
                path: "group/previsit-appointment",
                name: "ORGStaffPrevisitAppointment",
                component: () => import("@/views/org/staff/group/PrevisitAppointmentPage.vue"),
                meta: { title: "นัดหมายการตรวจเยี่ยม Previsit" },
            },
            {
                path: "group/previsit-results",
                name: "ORGStaffPrevisitResults",
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "ORGStaffInspectionResults",
                component: () =>
                    import("@/views/org/staff/InspectionResultsListPage.vue"),
                meta: { title: "บันทึกผลตรวจแปลง", statusFilter: "inspected" },
            },
            {
                path: "inspection-results/:id",
                name: "ORGStaffInspectionResultDetail",
                component: () =>
                    import("@/views/org/staff/InspectionResultsDetailPage.vue"),
                meta: { title: "รายละเอียดผลตรวจแปลง" },
            },
            {
                path: "propose-cc",
            ...
            },
            {
                ...
                name: "ORGStaffSaveCCResultDetail",
                component: () =>
                    import("@/views/org/staff/ResultsSaveCCDetailPage.vue"),
                meta: { title: "รายละเอียดผลตรวจแปลง" },
            },
            //แบบกลุ่ม
            {
                ...
                name: "ORGStaffGroupNewApplicationForm",
                component: () =>
                    import("@/views/org/staff/group/StaffNewApplicationPage.vue"),
                meta: { title: "ยื่นคำขอใหม่" },
            },
            {
                path: "group/applications",
                name: "ORGStaffGroupApplicationList",
                component: () =>
                    import("@/views/org/staff/group/ApplicationListPage.vue"),
                meta: { title: "รายการคำขอ" },
            },
            {
                path: "group/applications/:id",
                name: "ORGStaffGroupApplicationDetail",
                component: () =>
                    import("@/views/org/staff/group/ApplicationDetailPage.vue"),
                meta: { title: "รายละเอียดคำขอ GAP" },
            },
            {
                path: "group/schedule",
            ...
            },
            {
                ...
                name: "ORGStaffGroupInspectionResults",
                component: () =>
                    import("@/views/org/staff/group/InspectionResultsListPage.vue"),
                meta: { title: "บันทึกผลตรวจแปลง", statusFilter: "inspected" },
            },
            {
                path: "group/inspection-results/:id",
                name: "ORGStaffGroupInspectionResultDetail",
                component: () =>
                    import("@/views/org/staff/group/InspectionResultsDetailPage.vue"),
                meta: { title: "รายละเอียดผลตรวจแปลง" },
            },
            {
                path: "group/propose-cc",
            ...
            },
            {
                ...
                name: "ORGStaffGroupSaveCCResults",
                component: () =>
                    import("@/views/org/staff/group/ResultsSaveCCPage.vue"),
                meta: { title: "บันทึกผลจาก CC", statusFilter: "cc_savereviewing" },
            },
            {
                path: "group/previsit-appointment",
                name: "ORGStaffPrevisitAppointment",
                component: () =>
                    import("@/views/org/staff/group/PrevisitAppointmentPage.vue"),
                meta: { title: "นัดหมายการตรวจเยี่ยม Previsit" },
            },
            {
                path: "group/previsit-results",
                name: "ORGStaffPrevisitResults",
                component: () =>
                    import("@/views/org/staff/group/ResultsPrevisitAppointmentPage.vue"),
                meta: {
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "AdminStaffRegistration",
                component: () => import("@/views/admin/StaffRegistrationPage.vue"),
                meta: { title: "Staff Registration" },
            },
            {
    ...
    // ── Export System ─────────────────────────────────
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "ExportUserAmendment",
                component: () => import("@/views/export/user/AmendmentPage.vue"),
                meta: { title: "คำขอแก้ไขใบทะเบียน" },
            },
            {
                path: "applications/cancellation",
                name: "ExportUserCancellation",
                component: () => import("@/views/export/user/CancellationPage.vue"),
                meta: { title: "คำขอยกเลิกทะเบียน" },
            },
            {
                path: "certificates",
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "HCUserPayment",
                component: () => import("@/views/hc/user/PaymentPage.vue"),
                meta: { title: "ชำระเงิน" },
            },
            {
                path: "certificates",
    ...
    // ── HCEX System ───────────────────────────────────
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import("@/views/hcex/user/PaymentPage.vue"),
                meta: { title: "ชำระเงิน" },
            },
            {
                path: "history",
            ...
            },
            {
                ...
                component: () => import("@/views/hcex/user/CertificateDetailPage.vue"),
                meta: { title: "รายละเอียดใบทะเบียน" },
            },
        ],
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import("@/views/hcex/staff/CertificateDetailPage.vue"),
                meta: { title: "รายละเอียดใบทะเบียน" },
            },
            {
                path: "registry/:id/manage",
                name: "HCEXstaffCertificateManage",
                component: () => import("@/views/hcex/staff/CertificateManagePage.vue"),
                meta: { title: "จัดการใบรับรอง" },
            },
            {
                path: "certificates/:id",
            ...
            {
                path: "lab-waiting",
                name: "HCEXstaffLabWaitingList",
                component: () => import("@/views/hcex/staff/LabWaitingListPage.vue"),
                meta: { title: "รายการรอตรวจ LAB" },
            },
            {
                path: "lab-waiting/:id",
                name: "HCEXstaffLabResultRecord",
                component: () => import("@/views/hcex/staff/LabResultRecordPage.vue"),
                meta: { title: "บันทึกผล LAB" },
            },
            {
                path: "history-registry",
                name: "HCEXstaffHistoryRegistry",
                component: () => import("@/views/hcex/staff/HistoryRegistryPage.vue"),
                meta: { title: "รายการทะเบียนประวัติ" },
            },
            {
                path: "history-registry/:id",
                name: "HCEXstaffHistoryRegistryDetail",
                component: () =>
