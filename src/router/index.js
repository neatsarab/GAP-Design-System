  ...
  // ── GAP System ────────────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/InspectionResultsListPage.vue"),
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/InspectionResultsDetailPage.vue"),
      ...
      //แบบกลุ่ม
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/StaffNewApplicationPage.vue"),
        meta: { title: "ยื่นคำขอใหม่" },
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/ApplicationListPage.vue"),
        meta: { title: "รายการคำขอ" },
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/ApplicationDetailPage.vue"),
        meta: { title: "รายละเอียดคำขอ GAP" },
      },
      {
        path: "group/schedule",
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/InspectionResultsListPage.vue"),
        meta: { title: "บันทึกผลตรวจแปลง", statusFilter: "inspected" },
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/InspectionResultsDetailPage.vue"),
        meta: { title: "รายละเอียดผลตรวจแปลง" },
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/ResultsSaveCCPage.vue"),
        meta: { title: "บันทึกผลจาก CC", statusFilter: "cc_savereviewing" },
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/PrevisitAppointmentPage.vue"),
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/staff/group/ResultsPrevisitAppointmentPage.vue"),
        meta: {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/user/ApplicationTypeGroupPage.vue"),
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/user/forms/GroupFormForSinglePage.vue"),
        meta: { title: "ยื่นคำขอใหม่ รายเดี่ยว" },
      },
      {
        ...
        component: () =>
          import("@/views/gap/user/forms/GroupFormForGroupPage.vue"),
      ...
      },
      {
        ...
        component: () =>
          import("@/views/gap/user/forms/CancelGroupFormPage.vue"),
  ...
  // ── ORG System ────────────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/views/org/user/ApplicationTypeGroupPage.vue"),
        meta: { title: "เลือกประเภทใบรับรอง" },
      },
      {
        path: "applications/new/individual",
      ...
      },
      {
        ...
        component: () =>
          import("@/views/org/user/forms/GroupFormForSinglePage.vue"),
        meta: { title: "ยื่นคำขอใหม่ รายเดี่ยว" },
      },
      {
        path: "applications/new/group/:subtype",
        ...
        component: () =>
          import("@/views/org/user/forms/GroupFormForGroupPage.vue"),
        meta: { title: "ยื่นคำขอใหม่ รายกลุ่ม" },
      },
      {
        path: "applications/new/group/:subtype",
      ...
      },
      {
        ...
        component: () =>
          import("@/views/org/user/forms/CancelGroupFormPage.vue"),
        meta: { title: "แบบคำขอยกเลิกการรับรอง" },
      },
      {
        path: "applications/new/amendment",
