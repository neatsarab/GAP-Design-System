  ...
  <div>
    ...
    <div class="d-flex flex-column ga-3 mb-6">
      ...
      >
        ...
        คำขอ GAP-2569-001 ได้รับการอนุมัติเรียบร้อยแล้ว
      </v-alert>
    ...
    >
      ...
      <template #actions>
        <v-btn variant="text" icon="fas fa-xmark" @click="closeSnackbar" />
      </template>
    </v-snackbar>
  </div>
</template>
