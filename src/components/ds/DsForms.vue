        ...
        <v-row dense>
          ...
          <v-col cols="12" sm="4">
            ...
            <v-text-field
              ...
              maxlength="13" counter
              hint="ตัวเลข 13 หลัก ไม่ใส่ขีด" persistent-hint
            />
          </v-col>
          <v-col cols="12" sm="4">
            <div class="field-label">เบอร์โทรศัพท์ <span class="req">*</span></div>
            <v-text-field
              v-model="form.phone" placeholder="0XX-XXX-XXXX"
          ...
          <v-col cols="12" sm="4">
            ...
            <v-text-field
              v-model="form.email" placeholder="example@email.com"
              prepend-inner-icon="fas fa-envelope"
              hint="ถ้ามี — ใช้รับการแจ้งเตือน" persistent-hint
            />
          </v-col>
        </v-row>
      </v-card-text>
        ...
        <v-row dense>
          <v-col cols="12" sm="9">
            ...
            <v-textarea v-model="form.address" placeholder="บ้านเลขที่ / หมู่ที่ / ซอย / ถนน"
              prepend-inner-icon="fas fa-house" rows="2" auto-grow
      ...
      <v-card-text class="pt-5">
        <v-row dense>
          ...
          <v-col cols="12" sm="6" class="mt-2">
            ...
            <v-slider v-model="form.area" color="primary" track-color="surface-variant"
              :min="0" :max="100" :step="0.5" thumb-label hide-details />
          </v-col>
          <v-col cols="12" sm="6" class="mt-2">
            ...
            <v-range-slider v-model="form.elevRange" color="info" track-color="surface-variant"
          ...
          <v-col cols="12" sm="4">
            ...
            <div class="rounded-lg pa-3 bg-surface-variant">
              ...
              <v-switch v-model="form.group"   label="ยื่นคำขอรายกลุ่ม" color="info"
          ...
          <v-col cols="12" sm="6">
            ...
            <div v-if="photoPreviewUrls.length" class="d-flex flex-wrap ga-2 mt-3">
              <v-img v-for="(url, i) in photoPreviewUrls" :key="i"
                :src="url" :alt="`รูปแปลงปลูก ${i + 1}`"
                width="80" height="80" cover rounded="lg" class="border" />
            </div>
          </v-col>
          <v-col cols="12">
