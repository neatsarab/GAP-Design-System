<template>
  <div>
    ...
    <v-data-table :headers="headers" :items="rows" density="comfortable" hover>
...
const rows = [
  { no: "GAP-2569-001", farmer: "นาย สมชาย ใจดี", status: "DOC_REVIEW" },
  { no: "GAP-2569-002", farmer: "นาง มาลี เกษตรกิจ", status: "APPROVED" },
  { no: "GAP-2569-003", farmer: "นาย วิชัย ทำนา", status: "CERT_EXPIRED" },
  { no: "GAP-2569-004", farmer: "นาง สมศรี ปลูกผัก", status: "REJECTED" },
  { no: "GAP-2569-005", farmer: "นาย ประสิทธิ์ ไร่ดี", status: "CERT_ISSUED" },
  { no: "GAP-2569-006", farmer: "นาย อภิชาติ นาดี", status: "INSPECTING" },
];
</script>
