<template>
  <div>
    ...
    <AppConfirmDialog
      ...
      message="คุณต้องการลบคำขอ GAP-2569-001 ใช่หรือไม่? การดำเนินการนี้ไม่สามารถย้อนกลับได้"
      confirm-text="ลบ"
    ...
    <v-dialog v-model="formDialog" max-width="560">
      <v-card rounded="xl">
        <div class="d-flex align-center ga-3 px-6 pt-6 pb-4 border-b">
          ...
          <v-spacer />
          <v-btn icon size="small" variant="text" @click="closeFormDialog">
          ...
          <v-row dense>
            ...
            <v-col cols="12" sm="6">
              <v-autocomplete
                ...
                :items="['นาย วิจัย ตรวจดี', 'นาง สุดา ประเมิน']"
              />
            </v-col>
            <v-col cols="12">
        ...
        <v-card-actions class="px-6 pb-6 pt-0">
          <v-spacer />
          <v-btn variant="text" @click="closeFormDialog">ยกเลิก</v-btn>
          <v-btn color="primary" variant="flat" @click="closeFormDialog"
            >บันทึก</v-btn
          >
        </v-card-actions>
      </v-card>
      ...
      <v-card rounded="xl">
        <div class="d-flex align-center ga-3 px-6 pt-6 pb-4 border-b">
          ...
          <span class="text-subtitle-1 font-weight-bold"
            >ใบรับรอง GAP-C-2569-0089</span
          >
          <v-spacer />
          <v-btn icon size="small" variant="text" @click="closeInfoDialog">
            <v-icon icon="fas fa-xmark" />
          </v-btn>
        </div>
        ...
        <v-card-actions class="px-6 pb-6 pt-2">
          <v-btn
            ...
            >ดาวน์โหลด PDF</v-btn
          >
          <v-btn variant="text" @click="closeInfoDialog">ปิด</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
...
const certInfo = [
  ...
  {
    label: "วันออกใบรับรอง",
    value: "20 มี.ค. 2569",
    icon: "fas fa-calendar-days",
  },
  { label: "วันหมดอายุ", value: "19 มี.ค. 2569", icon: "fas fa-clock" },
];
</script>
