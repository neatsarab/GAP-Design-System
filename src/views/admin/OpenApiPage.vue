  ...
  <div>
    ...
    <div class="d-flex ga-2 flex-wrap mb-5">
      <v-chip color="success" variant="tonal" prepend-icon="fas fa-circle"
        >Active: {{ items.filter((i) => i.status === "Active").length }}</v-chip
      >
          ...
          <v-row dense>
            <v-col cols="12">
              <div class="field-label">
                <div>API Name <span class="req">*</span></div>
            ...
            <v-col cols="12" sm="8">
              <div class="field-label mt-3">
                <div>Endpoint <span class="req">*</span></div>
            ...
            <v-col cols="12" sm="4">
              <div class="field-label mt-3">
                <div>Method <span class="req">*</span></div>
