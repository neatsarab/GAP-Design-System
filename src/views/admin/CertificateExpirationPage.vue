  ...
  <div>
    <div class="mb-6">
      ...
      <p class="text-body-2 text-medium-emphasis mb-0">
        ติดตาม Certificate ที่กำลังจะหมดอายุ
      </p>
    </div>
    ...
    >
      มี <strong>{{ expiringSoon.length }}</strong> Certificate ที่จะหมดอายุใน
      30 วัน
    </v-alert>
...
const expiringSoon = computed(() =>
  certificates.filter((c) => c.daysLeft <= 30 && c.daysLeft >= 0),
);
