      ...
      <v-card-text class="pa-5">
        ...
        <v-row dense>
          <v-col v-for="bt in backupTypes" :key="bt.label" cols="12" sm="4">
            <v-card
              rounded="lg"
              class="backup-type-card pa-4 text-center"
              @click="setSelectedBackupType(bt.value)"
            >
              <div
                class="backup-type-icon mx-auto mb-2"
                :class="selectedBackupType === bt.value ? 'bg-admin' : ''"
                :style="
                  selectedBackupType !== bt.value
          ...
          <v-row dense>
            <v-col cols="12">
              <div class="field-label">
                <div>ระบบที่ต้องการสำรอง <span class="req">*</span></div>
                <div class="field-label-en">System to Backup</div>
              </div>
              <v-autocomplete
                v-model="backupForm.system"
                :items="['DOA System', 'GAP System', 'HCEX System', 'ทุกระบบ']"
                variant="outlined"
                density="compact"
                rounded="lg"
                hide-details
            ...
            <v-col cols="12">
              <div class="field-label mt-3">
                <div>รูปแบบการสำรอง <span class="req">*</span></div>
                <div class="field-label-en">Backup Format</div>
              </div>
              <v-radio-group
...
const backupTypes = [
  {
    ...
    value: "database",
    icon: "fas fa-database",
    desc: "สำรองข้อมูลฐานข้อมูล",
  },
  {
    label: "Backup Files",
    value: "files",
    icon: "fas fa-folder",
    desc: "สำรองไฟล์และเอกสาร",
  },
  {
    label: "Backup Configuration",
    value: "config",
    icon: "fas fa-gear",
    desc: "สำรองการตั้งค่าระบบ",
  },
];
