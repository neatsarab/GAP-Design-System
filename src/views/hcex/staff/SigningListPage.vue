    ...
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-6">
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          การออกใบรับรองสุขอนามัยสำหรับสินค้าแปรรูปด้านพืช
        </p>
      </div>
    </div>
...
const allItems = [
  {
    ...
    typecert: "ใบรับรองสุขอนามัย สําหรับส่งออกไปราชอาณาจักรโมร็อกโก (กมพ. 1–3)",
    type: "ต่ออายุ",
  ...
  },
  {
    ...
    typecert:
      "ใบรับรองสุขอนามัยแบบฟอร์ม สําหรับพืชงอก (Sprout)ส่งออกไปสหภาพยุโรป (กมพ. 1–2)",
    type: "ขึ้นทะเบียน",
  ...
  },
  {
    ...
    typecert: "ใบรับรองสุขอนามัย  สินค้าแปรรูปด้านพืช (กมพ.1)",
    type: "แก้ไข",
...
const typecertOptions = [
  {
    label: "ใบรับรองสุขอนามัย  สินค้าแปรรูปด้านพืช (กมพ.1)",
    value: "ใบรับรองสุขอนามัย  สินค้าแปรรูปด้านพืช (กมพ.1)",
  },
  {
    label: "ใบรับรองสุขอนามัยสําหรับประเทศในกลุ่มอ่าว (กมพ. 1-1)",
    value: "ใบรับรองสุขอนามัยสําหรับประเทศในกลุ่มอ่าว (กมพ. 1-1)",
  },
  {
    label:
      "ใบรับรองสุขอนามัยแบบฟอร์ม สําหรับพืชงอก (Sprout)ส่งออกไปสหภาพยุโรป (กมพ. 1–2)",
  ...
  {
    label: "ใบรับรองสุขอนามัย สําหรับส่งออกไปราชอาณาจักรโมร็อกโก (กมพ. 1–3)",
    value: "ใบรับรองสุขอนามัย สําหรับส่งออกไปราชอาณาจักรโมร็อกโก (กมพ. 1–3)",
  },
];
