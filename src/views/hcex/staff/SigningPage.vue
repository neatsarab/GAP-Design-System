        ...
        <v-card-text class="pa-5">
          ...
          >
            <span class="text-body-2"
              >กรุณาตรวจสอบข้อมูลให้ถูกต้องก่อนลงนาม
              การลงนามถือเป็นการยืนยันข้อมูลทั้งหมด</span
            >
          </v-alert>
        </v-card-text>
...
const signedTodayCount = computed(
  () => allItems.filter((i) => i.status === "signed").length,
);
