<template>
  <div>
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-6">
      <div>
        <h1 class="page-title mb-1">ทะเบียนประวัติ</h1>
        <p class="text-body-2 text-medium-emphasis mb-0">
          ข้อมูลทะเบียนประวัติสินค้าแปรรูปด้านพืชของสถานประกอบการ
        </p>
      </div>
      <v-btn
        v-if="history"
      ...
      <v-btn
        ...
        @click="goToRegister"
      >
        ยื่นขอขึ้นทะเบียนประวัติ
      </v-btn>
    </div>

    <!-- ยังไม่มีทะเบียน -->
    <template v-if="!history">
      <v-card rounded="xl" elevation="0" class="text-center pa-10">
        <v-icon
        ...
        <v-card-text class="pt-4">
          ...
          <v-row dense class="mb-3">
            <v-col cols="12" sm="4">
              <div class="info-label">หน่วยงานที่รับรอง</div>
              <div class="info-value">
                {{ history.standards.haccp.certBody }}
              </div>
            </v-col>
            <v-col cols="12" sm="4">
              <div class="info-label">หมายเลขการรับรอง</div>
