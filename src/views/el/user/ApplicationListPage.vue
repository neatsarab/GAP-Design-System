        ...
        <div class="d-flex align-center justify-space-between mb-6 flex-wrap ga-3">
            <div>
                ...
                <p class="text-body-2 text-medium-emphasis mb-0">
                    คำขอขึ้นทะเบียนโรงคัดบรรจุทั้งหมด
                </p>
            </div>
            <v-btn color="el-user" prepend-icon="fas fa-plus" rounded="lg" @click="goToNewApplication">
                ยื่นคำขอใหม่
            </v-btn>
        </div>
            ...
            <v-card-text class="pa-4">
                <v-row dense align="center">
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <v-text-field v-model="search" placeholder="ค้นหาเลขคำขอ / ชื่อโรงคัดบรรจุ"
                            prepend-inner-icon="fas fa-magnifying-glass" variant="outlined" density="compact"
                    ...
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <v-autocomplete v-model="statusFilter" :items="statusOptions" item-title="label"
                    ...
                    <div class="d-flex ga-1">
                        <v-tooltip text="ดูรายละเอียด" location="top">
                            <template #activator="{ props }">
                                <v-btn v-bind="props" icon size="x-small" variant="text" color="el-user"
