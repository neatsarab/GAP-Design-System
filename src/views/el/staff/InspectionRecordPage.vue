    ...
    <v-window v-model="page" :touch="false">
      ...
      <v-window-item value="main">
        <template v-if="currentStep === 0">
          ...
          <v-card rounded="xl" elevation="0" class="mb-5 section-card">
            <v-row dense class="pa-5">
              <v-col cols="12" md="4">
                ...
                <v-text-field
                  v-model="establishmentInfo.appCode"
                  variant="outlined"
                  rounded="lg"
                  density="comfortable"
                  readonly
              ...
              <v-col cols="12" md="4">
                ...
                <v-text-field
                  v-model="establishmentInfo.appDate"
                  type="date"
                  variant="outlined"
                  rounded="lg"
                  density="comfortable"
              ...
              <v-col cols="12" md="4">
                ...
                <v-select
                  v-model="establishmentInfo.appStatus"
                  :items="['รอตรวจเอกสาร']"
                  variant="outlined"
                  rounded="lg"
                  density="comfortable"
            ...
            <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
              >1. ข้อมูลโรงคัดบรรจุ</v-card-title
            >
            <v-card-text class="pa-5">
              <v-row dense>
                ...
                <v-col cols="12" md="4">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.certCode"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="4">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.issueDate"
                    type="date"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                ...
                <v-col cols="12" md="4">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.expireDate"
                    type="date"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                ...
                <v-col cols="12">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.name"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.contactFirstName"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.contactLastName"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.address"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-select
                    v-model="establishmentInfo.province"
                    :items="['กรุงเทพมหานคร']"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-select
                    v-model="establishmentInfo.district"
                    :items="['เขตลาดพร้าว']"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-select
                    v-model="establishmentInfo.subdistrict"
                    :items="['ลาดพร้าว']"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.zipcode"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.phone"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.mobile"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.email"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    hide-details
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.approveDate"
                    type="date"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                ...
                <v-col cols="12" md="6">
                  ...
                  <v-text-field
                    v-model="establishmentInfo.status"
                    variant="outlined"
                    rounded="lg"
                    density="comfortable"
                    readonly
          ...
          <v-card rounded="xl" elevation="0" class="mb-5 section-card">
            <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
              >3. ข้อมูลแปลงเกษตร</v-card-title
            >
            <v-card-text class="pa-5">
              <v-data-table
                :headers="resultHeadersDetail"
                :items="resultItems"
                density="comfortable"
                class="border rounded-lg custom-result-table"
                hide-default-footer
              >
          ...
          <v-card rounded="xl" elevation="0" class="mb-5 section-card">
            <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
              >4. ข้อมูลแปลงเกษตรที่ขอใบรับรอง GAP</v-card-title
            >
            <v-card-text class="pa-5">
              <v-data-table
                :headers="resultHeadersDetailGap"
                :items="resultItemsGap"
                density="comfortable"
                class="border rounded-lg custom-result-table"
                hide-default-footer
              >
          ...
          <v-card rounded="xl" elevation="0" class="mb-5 section-card">
            <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
              >5.ข้อมูลใบรับรอง GMP ของโรงคัดบรรจุ</v-card-title
            >
            <v-card-text class="pa-5">
              <v-data-table
                :headers="factoryHeadersDetail"
                :items="factories"
                density="compact"
                class="border rounded-lg custom-table"
                hide-default-footer
              >
                <template v-slot:item.view="{ item }">
                  <v-btn
          ...
          <v-card rounded="xl" elevation="0" class="mb-5 section-card">
            <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
              >6. ผลการพิจารณา</v-card-title
            >
            <v-card-text class="pa-5">
              <v-data-table
                :headers="resultHeadersDetailReview"
                :items="resultItemsDetail"
                density="compact"
      ...
      <v-window-item value="form">
        <v-card rounded="xl" elevation="0" class="mb-5 section-card">
          <v-card-title
            class="pa-5 pb-3 section-title font-weight-bold d-flex align-center"
          >
            <v-icon
          ...
          <v-card-text class="pa-8">
            <v-row dense v-if="editType === 'farmer'">
                  ...
                  <v-row dense>
                    <v-col cols="12" md="6">
                      <div class="align-center mb-2">
                        ...
                        <v-select
                          v-model="tempData.appType"
                          :items="['ตรวจขึ้นทะเบียนใหม่']"
                          variant="outlined"
                          rounded="lg"
                          density="compact"
                          hide-details
                  ...
                  <v-row dense>
                    <v-col cols="12" md="6">
                      <div class="align-center mb-2">
                        ...
                        <v-select
                          v-model="tempData.farmerName"
                          :items="['นาง จันทร์จิรา เครือพลับ']"
                          variant="outlined"
                          rounded="lg"
                          density="compact"
                          hide-details
              ...
              <v-col cols="12" class="mt-n5">
                ...
                <v-table
                  density="comfortable"
                  class="border rounded-lg planting-table mb-8"
                >
                  <thead>
                  ...
                  <tbody>
                    <tr
                      v-for="(plan, index) in tempData.plantingPlans"
                      :key="index"
                    >
              ...
              <v-col cols="12">
                <v-row dense>
                  ...
                  <v-col cols="12" md="6">
                    ...
                    <v-text-field
                      v-model="tempData.yieldPerCycle"
                      variant="outlined"
                      rounded="lg"
                      density="comfortable"
                      readonly
                  ...
                  <v-col cols="12" md="6">
                    ...
                    <v-select
                      v-model="tempData.subdistrict"
                      :items="['สำนักวิจัยและพัฒนาการเกษตรเขตที่ 5']"
                      variant="outlined"
                      rounded="lg"
                      density="comfortable"
                      readonly
                  ...
                  <v-col cols="12" md="6">
                    ...
                    <v-select
                      v-model="tempData.subdistrict"
                      :items="['ศูนย์วิจัยและพัฒนาการเกษตรนครปฐม']"
                      variant="outlined"
                      rounded="lg"
                      density="comfortable"
                      readonly
              ...
              <v-col cols="12">
                <v-card
                  rounded="lg"
                  elevation="0"
                  class="mb-5 overflow-hidden border pa-5"
                >
                  <v-card-title
                    class="pa-0 border-bottom d-flex align-center bg-white"
                  >
                    <v-btn
                      color="el-staff"
                      class="border-right rounded-0 elevation-0 px-2 py-2 mb-5"
                      height="auto"
                ...
                <v-card rounded="lg" elevation="0" class="pa-6 border mb-8">
                  ...
                  <v-row dense>
                    <v-col
                      cols="12"
                      md="2"
                      class="text-right pt-2 font-weight-bold"
                      >ผลการพิจารณา :</v-col
                    >
                    <v-col cols="12" md="4">
                      <v-select
                        v-model="tempData.zoneResult"
                        :items="['ผ่าน', 'ไม่ผ่าน', 'ปรับปรุง']"
                        variant="outlined"
                        rounded="lg"
                        density="compact"
                        hide-details
                    ...
                    <v-col
                      cols="12"
                      md="2"
                      class="text-right pt-2 font-weight-bold mt-2"
                      >หมายเหตุ :</v-col
                    >
                    <v-col cols="12" md="10" class="mt-2">
                      <v-textarea
                        v-model="tempData.zoneRemark"
                        variant="outlined"
                        rounded="lg"
                        density="compact"
                        rows="3"
                    ...
                    <v-col
                      ...
                      >แนบไฟล์ :</v-col
                    >
                    <v-col cols="12" md="10" class="pt-4 text-medium-emphasis"
                      >ไม่มีไฟล์แนบ</v-col
                    >
                    ...
                    <v-col cols="12" md="4" class="mt-2">
                      <v-select
                        v-model="tempData.zoneRecorder"
                        :items="['เจ้าหน้าที่ตรวจประเมิน']"
                        variant="outlined"
                        rounded="lg"
                        density="compact"
                        hide-details
                    ...
                    <v-col
                      ...
                      md="2"
                      class="text-right pt-2 font-weight-bold mt-2"
                      >วันที่บันทึกผล :</v-col
                    >
                    <v-col cols="12" md="4" class="mt-2">
                      <v-text-field
                        v-model="tempData.zoneDate"
                        type="date"
                        variant="outlined"
                        rounded="lg"
                        density="compact"
                  ...
                  <div class="d-flex justify-center ga-3 mt-8">
                    <v-btn
                      variant="outlined"
                      rounded="lg"
                      class="px-8 border bg-grey-lighten-4"
                      @click="saveMainData"
                    >
                      <v-icon
                        icon="fas fa-save"
          ...
          <v-card-text class="pa-8">
            <v-row dense class="mb-6">
              ...
              <v-col cols="12" class="align-center mt-1">
                ...
                <v-select
                  v-model="cl02Form.establishmentName"
                  :items="['บริษัท ฟลอร่า แคปปิทอล จำกัด (1)']"
                  variant="outlined"
                  rounded="lg"
                  density="compact"
                  hide-details
              ...
              <thead>
                <tr class="bg-grey-lighten-4">
                  ...
                  <th class="text-center" style="width: 35%">
                    เหตุผล / เอกสาร / หลักฐาน
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="(item, idx) in cl02Items" :key="idx">
                  <td class="pa-4 border-right align-start">
                    <div class="font-weight-bold text-body-2">
                      {{ item.label }}
                    </div>
                    <div v-if="item.sub" class="mt-1">
                      <div
                        v-for="s in item.sub"
                        :key="s"
                        class="ml-4 text-caption text-grey-darken-2"
                      >
                        {{ s }}
                      </div>
                    </div>
                  ...
                  <td class="text-center border-right">
                    <v-radio-group
                      v-model="cl02Form.answers[idx]"
                      class="mt-0 d-inline-flex"
                      hide-details
                      ><v-radio value="yes" color="grey"
                    /></v-radio-group>
                  </td>
                  <td class="text-center border-right">
                    <v-radio-group
                      ...
                      class="mt-0 d-inline-flex"
                      hide-details
                      ><v-radio value="no" color="grey"
                    /></v-radio-group>
                  </td>
                  <td class="pa-1">
                    <v-textarea
                      v-model="cl02Form.remarks[idx]"
                      variant="outlined"
                      rounded="0"
                      density="compact"
                      hide-details
            ...
            <div class="pa-6 border bg-grey-lighten-5 mb-8">
              ...
              <div class="field-label mb-1">หมายเหตุ</div>
              <v-textarea
                v-model="cl02Form.overallRemark"
                variant="outlined"
                rounded="lg"
                density="compact"
                rows="3"
              ...
              <v-col cols="12" md="6">
                <div class="align-center mb-2">
                  ...
                  <v-text-field
                    ...
                    hide-details
                    placeholder="Browse..."
                    append-inner-icon="fas fa-folder-open"
                    readonly
                  />
                </div>
              </v-col>
            ...
            <v-row dense class="mt-8 bg-grey-lighten-4 pa-6 rounded border">
              <v-col cols="12" md="6">
                <div class="d-flex align-center mb-2">
                  ...
                  <v-select
                    v-model="cl02Form.inspector"
                    :items="['นายผู้ตรวจ งานดี']"
                    variant="outlined"
                    rounded="lg"
                    density="compact"
                    hide-details
...
const cl02Items = [
  ...
  {
    label:
      "2. ผู้ประกอบการเข้าตรวจประเมินความเสี่ยงของพื้นที่เพาะปลูกและแหล่งน้ำ",
  },
  {
    label:
      "3. มีการสุ่มตัวอย่างผลผลิต และน้ำวิเคราะห์สารเคมีตกค้างและเชื้อจุลินทรีย์",
  },
  {
    label:
      "4. ผู้ประกอบการได้มีการทบทวนการขึ้นทะเบียนแปลง (AVL) ของเกษตรกรที่สมัครเข้าเป็นสมาชิกเครือข่าย",
  },
  {
    label: "5. การฝึกอบรมเกษตรกรผู้ปลูก",
    sub: [
      "5.1 ด้านการใช้สารเคมี",
      "5.2 ด้านการปนเปื้อนของสารเคมีและจุลินทรีย์",
      "5.3 โรคแมลงศัตรูพืชที่ติดกับผลผลิต",
      "5.4 ด้านการจัดการหลังเก็บเกี่ยว",
    ],
  },
  {
    label: "6. อื่นๆ",
