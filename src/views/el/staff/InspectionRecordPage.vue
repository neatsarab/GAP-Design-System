<template>
    <div style="--v-theme-el-staff: var(--v-theme-el-staff)">
        ...
        <div class="d-flex align-center ga-3 mb-6">
            <div>
                <h1 class="page-title mb-0">รายการตรวจ GAP</h1>
        ...
        <v-window v-model="page" :touch="false">
            ...
            <v-window-item value="main">
                <template v-if="currentStep === 0">
                    ...
                    <v-card rounded="xl" elevation="0" class="mb-5 section-card">
                        ...
                        <v-card-text class="pa-5">
                            ...
                            <div class="field-label mb-2 font-weight-bold">
                                เอกสารประกอบคำขอขึ้นทะเบียน (Establishment List)
                            </div>
                            <v-table density="comfortable" class="border rounded-lg mb-8">
                                <thead>
                                    <tr class="bg-grey-lighten-4">
                                        ...
                                        <th class="text-left font-weight-bold" style="width: 25%">
                                            เอกสารแนบ
                                        </th>
                                    ...
                                    <tr>
                                        <td class="pa-4">
                                            <div class="text-body-2 mb-1">
                                                1. หนังสือแสดงความประสงค์การเข้าร่วมการจัดทำบัญชี
                                                Establishment List ลงนามโดยผู้มีอำนาจของบริษัท
                                            </div>
                                        </td>
                                        <td class="pa-2">
                                    ...
                                    <tr>
                                        <td class="pa-4">
                                            <div class="text-body-2 mb-1">
                                                ...
                                                Establishment List
                                                ในกรณีที่หนังสือไม่ได้ลงนามโดยผู้มีอำนาจของบริษัท
                                            </div>
                                        </td>
                                        <td class="pa-2">
                                            <v-file-input variant="outlined" rounded="lg" density="compact" hide-details
                ...
                <template v-else>
                    <v-card rounded="xl" class="pa-10 text-center">
                        ...
                        <h2 class="text-h5 text-grey">
                            อยู่ระหว่างการพัฒนาเนื้อหา Step {{ currentStep + 1 }}
                        </h2>
                    </v-card>
                </template>
                    ...
                    <v-card-text class="pa-8">
                        <v-row dense v-if="editType === 'farmer'">
                            ...
                            <v-col cols="12" class="mt-n5">
                                <div class="field-label mb-1 font-weight-bold text-el-staff">
                                    แผนการเพาะปลูก
                                </div>
                                ...
                                <v-table density="comfortable" class="border rounded-lg planting-table mb-8">
                                    <thead>
                                        <tr class="bg-grey-lighten-3">
                                            ...
                                            <th class="text-center border-right font-weight-bold">
                                                แผนการเพาะปลูก
                                            </th>
                                            <th class="text-center border-right font-weight-bold">
                                                ระยะเวลาเก็บเกี่ยว
                                    ...
                                    <tbody>
                                        <tr v-for="(plan, index) in tempData.plantingPlans" :key="index">
                                            <td class="text-center border-right">
                                                <v-checkbox v-model="plan.selected" density="compact" hide-details />
                                            </td>
                            ...
                            <v-col cols="12">
                                <v-row dense>
                                    ...
                                    <v-col cols="12" md="6">
                                        ...
                                        <v-select v-model="tempData.district" :items="['ลาดพร้าว']" variant="outlined"
                                            rounded="lg" density="comfortable" readonly hide-details />
                                    </v-col>
                                    <v-col cols="12" md="6">
                                    ...
                                    <v-col cols="12" md="6">
                                        ...
                                        <v-select v-model="tempData.subdistrict" :items="['Flora Capital Co., Ltd.']"
                                            variant="outlined" rounded="lg" density="comfortable" readonly
                                            hide-details />
                                    </v-col>
                                    <v-col cols="12" md="6">
                                        <div class="field-label mb-1">วันที่สร้างข้อมูล</div>
                                        <v-select v-model="tempData.subdistrict" :items="['11/02/2026']"
                                            variant="outlined" rounded="lg" density="comfortable" readonly
                                            hide-details />
                                    </v-col>
                                    <v-col cols="12" md="6">
                                    ...
                                    <v-col cols="12" md="6">
                                        ...
                                        <v-select v-model="tempData.subdistrict"
                                            :items="['สำนักวิจัยและพัฒนาการเกษตรเขตที่ 5']" variant="outlined"
                                            rounded="lg" density="comfortable" readonly hide-details />
                                    </v-col>
                                    <v-col cols="12" md="6">
                                        <div class="field-label mb-1">ศวพ. จังหวัด</div>
                                        <v-select v-model="tempData.subdistrict"
                                            :items="['ศูนย์วิจัยและพัฒนาการเกษตรนครปฐม']" variant="outlined"
                                            rounded="lg" density="comfortable" readonly hide-details />
                                    </v-col>
                                    <v-col cols="12" md="6">
                                        <div class="field-label mb-1">ผู้ตรวจล่าสุด</div>
                                        <v-select v-model="tempData.subdistrict" :items="[]" variant="outlined"
                                            rounded="lg" density="comfortable" readonly hide-details />
                                    </v-col>
                                </v-row>
                            ...
                            <v-col cols="12">
                                <div class="d-flex justify-center">
                                    <v-btn color="el-staff" prepend-icon="fas fa-check" rounded="lg"
                            ...
                            <!-- ตารางรายการ CL-02 -->
                            <v-col cols="12">
                                <v-card rounded="lg" elevation="0" class="mb-5 overflow-hidden border pa-5">
                                    <v-card-title class="pa-0 border-bottom d-flex align-center bg-white">
                                        <v-btn color="el-staff"
                                    ...
                                    <v-table density="compact" class="cl02-history-table">
                                        <thead>
                                            <tr class="bg-grey-lighten-3">
                                                <th class="text-center border-right">แก้ไขข้อมูล</th>
                                            ...
                                            <tr v-for="item in cl02History" :key="item.id">
                                                <td class="text-center border-right">
                                                    <v-btn icon="fas fa-edit" size="x-small" variant="text"
                                                        color="el-staff" @click="page = 'cl02-form'" />
                                                </td>
                                                <td class="text-center border-right">
                                                    {{ item.count }}
                                                </td>
                            ...
                            <!-- 4. ผลการพิจารณาโดย สวพ.เขต -->
                            <v-col cols="12">
                                <v-card rounded="lg" elevation="0" class="pa-6 border mb-8">
                                    <h3 class="text-el-staff mb-4 font-weight-bold">
                                        ผลการพิจารณาโดย สวพ.เขต
                                    </h3>
                                    <v-row dense>
                                        <v-col cols="12" md="2" class="text-right pt-2 font-weight-bold">ผลการพิจารณา
                                            :</v-col>
                                        <v-col cols="12" md="4">
                                            <v-select v-model="tempData.zoneResult"
                                                :items="['ผ่าน', 'ไม่ผ่าน', 'ปรับปรุง']" variant="outlined" rounded="lg"
                                                density="compact" hide-details />
                                        </v-col>
                                        <v-col cols="12" md="6" />

                                        <v-col cols="12" md="2" class="text-right pt-2 font-weight-bold mt-2">หมายเหตุ
                                            :</v-col>
                                        ...
                                        <v-col cols="12" md="2" class="text-right pt-2 font-weight-bold mt-2">แนบไฟล์
                                            :</v-col>
                                        <v-col cols="12" md="10" class="pt-4 text-medium-emphasis">ไม่มีไฟล์แนบ</v-col>

                                        <v-col cols="12" md="2"
                                            class="text-right pt-2 font-weight-bold mt-2">ผู้บันทึกผล
                                            :</v-col>
                                        ...
                                        <v-col cols="12" md="2"
                                            class="text-right pt-2 font-weight-bold mt-2">วันที่บันทึกผล
                                            :</v-col>
                                        <v-col cols="12" md="4" class="mt-2">
                                    ...
                                    <div class="d-flex justify-center ga-3 mt-8">
                                        ...
                                        <v-btn variant="outlined" rounded="lg" class="px-8 border bg-grey-lighten-4"
                                            @click="page = 'main'">
                                            <v-icon icon="fas fa-arrow-left" color="el-staff" class="mr-2" />
                                            ย้อนกลับ
                                        </v-btn>
                                    </div>
                                </v-card>
                        ...
                        <v-row v-else-if="editType === 'factory'">
                            <v-col cols="12" class="text-center py-10">
                                <h2 class="text-grey">
                                    ส่วนแสดงข้อมูลใบรับรองโรงคัดบรรจุ (Read Only / Edit Mode)
                                </h2>
                            </v-col>
                        </v-row>
                    </v-card-text>
            ...
            <!-- ─── PAGE: CL-02 FULL FORM ─── -->
            <v-window-item value="cl02-form">
                <v-card rounded="xl" elevation="0" class="mb-5 section-card">
                    <v-card-title class="pa-5 pb-3 section-title font-weight-bold d-flex align-center">
                        <v-icon icon="fas fa-file" class="mr-2" color="el-staff" size="20" />
                        CL-02
                    </v-card-title>
                    <v-divider />
                    <!-- Info Header -->
                    <v-card-text class="pa-8">
                        <v-row dense class="mb-6">
                            <v-col cols="12" md="6">
                                ...
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">ประเภทการตรวจ</div>
                                    <v-text-field v-model="cl02Form.evalType" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">รหัสแปลง</div>
                                    <v-text-field v-model="cl02Form.farmCode" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">รหัสใบรับรอง</div>
                                    <v-text-field v-model="cl02Form.certNo" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                            </v-col>
                            <v-col cols="12" md="6">
                                ...
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">ครั้งที่</div>
                                    <v-text-field v-model="cl02Form.evalCount" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">ขนาดพื้นที่ปลูก (ไร่)</div>
                                    <v-text-field v-model="cl02Form.areaSize" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                            </v-col>
                            <v-col cols="12" class="align-center mt-1">
                                <div class="field-label mb-1">ที่ตั้งแปลง</div>
                                <v-text-field v-model="cl02Form.address" variant="outlined" rounded="lg"
                                    density="compact" hide-details />
                            </v-col>
                            <v-col cols="12" class="align-center mt-1">
                                <div class="field-label mb-1">ที่ตั้งแปลง</div>
                            ...
                            <v-col cols="12" md="6">
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">จังหวัด</div>
                                    <v-select v-model="cl02Form.province" :items="['นครปฐม']" variant="outlined"
                                        rounded="lg" density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">อำเภอ/เขต</div>
                                    <v-select v-model="cl02Form.district" :items="['เมืองนครปฐม']" variant="outlined"
                                        rounded="lg" density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">ตำบล/แขวง</div>
                                    <v-select v-model="cl02Form.subdistrict" :items="['สวนปาน']" variant="outlined"
                                        rounded="lg" density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">รหัสไปรษณีย์</div>
                                    <v-text-field v-model="cl02Form.zipcode" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                            </v-col>
                            <v-col cols="12" md="6">
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">พิกัด X</div>
                                    <v-text-field v-model="cl02Form.coordX" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">พิกัด Y</div>
                                    <v-text-field v-model="cl02Form.coordY" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                                <div class="align-center mb-1">
                                    <div class="field-label mb-1">พิกัด Z</div>
                                    <v-text-field v-model="cl02Form.coordZ" variant="outlined" rounded="lg"
                                        density="compact" hide-details />
                                </div>
                            </v-col>
                            <v-col cols="12" class="align-center mt-1">
                                <div class="field-label mb-1">ชื่อโรงคัดบรรจุ</div>
                                <v-select v-model="cl02Form.establishmentName"
                                    :items="['บริษัท ฟลอร่า แคปปิทอล จำกัด (1)']" variant="outlined" rounded="lg"
                                    density="compact" hide-details />
                            </v-col>
                        </v-row>

                        <!-- Checklist Table (6 Items) -->
                        <v-table class="checklist-table border mb-4" density="compact">
                            <thead>
                                <tr class="bg-grey-lighten-4">
                                    <th class="text-center border-right py-3">รายการตรวจ</th>
                                    <th class="text-center border-right" style="width: 100px">ใช่ / มี</th>
                                    <th class="text-center border-right" style="width: 100px">ไม่ใช่ / ไม่มี</th>
                                    <th class="text-center" style="width: 35%">เหตุผล / เอกสาร / หลักฐาน</th>
                                </tr>
                            </thead>
                            <tbody>
                                <template v-for="(item, idx) in cl02Items" :key="idx">
                                    <tr v-if="item.type === 'header'" class="bg-grey-lighten-4">
                                    ...
                                    <tr v-else>
                                        <td class="pa-4 border-right align-start">
                                            <div
                                                :class="[item.isSub ? 'ml-6 text-caption text-grey-darken-2' : 'font-weight-bold text-body-2']">
                                                {{ item.label }}
                                            </div>
                                        </td>
                                        <td class="text-center border-right">
                                            <v-radio-group v-model="cl02Form.answers[idx]" class="mt-0 d-inline-flex"
                                                hide-details>
                                        ...
                                        <td class="text-center border-right">
                                            <v-radio-group v-model="cl02Form.answers[idx]" class="mt-0 d-inline-flex"
                                                hide-details>
                                                <v-radio value="no" color="error" />
                                            </v-radio-group>
                                        </td>
                                        <td class="pa-1">
                                            <v-textarea v-model="cl02Form.remarks[idx]" variant="outlined" rounded="0"
                                                density="compact" hide-details rows="1" auto-grow bg-color="white" />
                                        </td>
                                    </tr>
                        ...
                        <div class="d-flex justify-center mt-4 mb-4">
                            <v-btn color="success" prepend-icon="fas fa-check-double" variant="flat" rounded="lg"
                                @click="yesAllDocuments">ใช่/มี ทั้งหมด</v-btn>
                        </div>

                        <!-- Form Summary & Remarks -->
                        <div class="pa-6 border bg-grey-lighten-5 mb-8">
                            <div class="d-flex justify-center mb-4">
                                <v-radio-group v-model="cl02Form.overall" inline hide-details
                                    class="cl02-overall-radio">
                                    <v-radio label="ผ่าน" value="pass" color="success" class="mr-15 font-weight-bold" />
                                    <v-radio label="ไม่ผ่าน" value="fail" color="error" class="font-weight-bold" />
                                </v-radio-group>
                            </div>
                            <div class="field-label mb-1">หมายเหตุ</div>
                            <v-textarea v-model="cl02Form.overallRemark" variant="outlined" rounded="lg"
                                density="compact" rows="3" hide-details bg-color="white" />
                        </div>

                        <!-- Signatures and Photos Upload -->
                        <v-row dense>
                            <v-col cols="12" md="6">
                                <div class="align-center mb-2">
                                    <div class="field-label mb-1">ลายเซ็นเกษตรกร</div>
                                    <v-text-field variant="outlined" rounded="lg" density="compact" hide-details
                                        placeholder="Browse..." append-inner-icon="fas fa-folder-open" readonly />
                                </div>
                            </v-col>
                            <v-col cols="12" md="6" v-for="n in 4" :key="n">
                                <div class="align-center mb-2">
                                    <div class="field-label mb-1">ภาพถ่ายแปลงเกษตรกร {{ n }}</div>
                                    <v-text-field variant="outlined" rounded="lg" density="compact" hide-details
                                        placeholder="Browse..." append-inner-icon="fas fa-folder-open" readonly />
                                </div>
                            </v-col>
                        ...
                        <v-row dense class="mt-8 bg-grey-lighten-4 pa-6 rounded border">
                            <v-col cols="12" md="6">
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">ผู้ตรวจ</div>
                                    <v-select v-model="cl02Form.inspector" :items="['นายผู้ตรวจ งานดี']"
                                        variant="outlined" rounded="lg" density="compact" hide-details
                                        bg-color="white" />
                                </div>
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">สถานะ</div>
                                    <v-select v-model="cl02Form.status" :items="['สมบูรณ์']" variant="outlined"
                                        rounded="lg" density="compact" hide-details bg-color="white" />
                                </div>
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">ผู้สร้างข้อมูล</div>
                                    <v-text-field v-model="cl02Form.creator" variant="outlined" rounded="lg"
                                        density="compact" hide-details bg-color="white" />
                                </div>
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">ผู้แก้ไขข้อมูล</div>
                                    <v-text-field v-model="cl02Form.editor" variant="outlined" rounded="lg"
                                        density="compact" hide-details bg-color="white" />
                                </div>
                            </v-col>
                            <v-col cols="12" md="6">
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">
                                        <div class="text-error font-weight-black">*</div>
                                        วันที่ตรวจ :
                                    </div>
                                ...
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">กำหนดตรวจ</div>
                                    <v-text-field type="date" variant="outlined" rounded="lg" density="compact"
                                        hide-details bg-color="white" />
                                </div>
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">วันที่สร้างข้อมูล</div>
                                    <v-text-field variant="outlined" rounded="lg" density="compact" hide-details
                                        bg-color="white" />
                                </div>
                                <div class="d-flex align-center mb-2">
                                    <div class="field-label mr-1">วันที่แก้ไขข้อมูล</div>
                                    <v-text-field variant="outlined" rounded="lg" density="compact" hide-details
                                        bg-color="white" />
                                </div>
                            </v-col>
                        ...
                        <div class="d-flex justify-center ga-3 mt-8">
                            <v-btn variant="outlined" rounded="lg" class="px-8 border bg-grey-lighten-4">
                                <v-icon icon="fas fa-print" class="mr-2" color="blue" />
                                พิมพ์ข้อมูล
                            </v-btn>
                            <v-btn variant="outlined" rounded="lg" class="px-8 border bg-grey-lighten-4"
                                @click="saveCL02">
                                <v-icon icon="fas fa-save" class="mr-2" color="grey-darken-3" />
                                บันทึก
                            </v-btn>
                            <v-btn variant="outlined" rounded="lg" class="px-8 border bg-grey-lighten-4"
                                @click="page = 'form'">
                                <v-icon icon="fas fa-arrow-left" class="mr-2" color="success" />
                                ย้อนกลับ
                            </v-btn>
                        </div>
                    </v-card-text>
        ...
        <v-dialog v-model="successDialog" max-width="440" persistent>
            <v-card rounded="xl">
                <v-card-text class="pa-8 text-center">
                    ...
                    <v-chip color="el-staff" size="large" variant="tonal" class="mb-4">{{
                        establishmentInfo.appCode
                        }}</v-chip>
                    <p class="text-body-2 text-medium-emphasis">
                        ระบบได้รับคำขอของท่านแล้ว เจ้าหน้าที่จะตรวจสอบและติดต่อกลับ
                    </p>
                </v-card-text>
                <v-card-actions class="px-6 pb-5"><v-btn color="el-staff" rounded="lg" block @click="
                    page = 'main';
                successDialog = false;
                ">ตกลง</v-btn></v-card-actions>
            </v-card>
        </v-dialog>
    </div>
</template>
    ...
    rejectionLog: [
        {
            ...
            date: "2026-03-25",
            remark:
                "เอกสารแนบข้อ 4 (บัญชีรายชื่อสารเคมี) ไฟล์ไม่ชัดเจน กรุณาแนบไฟล์ใหม่",
        },
        {
            count: 1,
            seq: 2,
...
const factories = ref([
    { id: 1, cropName: "ผักชีไทย", gmpNo: "GMP-999", status: "รออนุมัติผล" },
]);
...
const resultItemsDetail = ref([
    {
        cropName: "ผักชีไทย",
        farmerName: "พลอย จินดามณี / โชติช่วง ชัชวาล",
        certNo: "กษ-1484",
        farmCode: "-",
        docResult: "รอพิจารณา",
        status: "รอตรวจเอกสาร",
...
const farmDocCheckList = [
    {
        key: "farmer_summary",
        label: "1. ตารางสรุปรายชื่อเกษตรกร :",
        required: true,
    },
    ...
    {
        key: "visit_report",
        label: "- แผนการบันทึกการตรวจเยี่ยม :",
        isSub: true,
        required: true,
    },
    {
        key: "lab_analysis",
        label: "- ผลวิเคราะห์สารตกค้าง :",
        isSub: true,
        required: true,
    },
    {
        key: "education_evidence",
        label: "6. หลักฐานการให้ความรู้ :",
        required: true,
    },
];

const masterSwpProvinces = [
    "ศวพ.เชียงใหม่",
    "ศวพ.จันทบุรี",
    "ศวพ.สุราษฎร์ธานี",
];
...
const cl02Items = [
    { label: "1. มีบันทึกการตรวจติดตาม/การตรวจเยี่ยมแปลงพืช", type: 'item' },
    { label: "2. ผู้ประกอบการเข้าตรวจประเมินความเสี่ยงของพื้นที่เพาะปลูกและแหล่งน้ำ", type: 'item' },
    { label: "3. มีการสุ่มตัวอย่างผลผลิต และน้ำวิเคราะห์สารเคมีตกค้างและเชื้อจุลินทรีย์", type: 'item' },
    { label: "4. ผู้ประกอบการได้มีการทบทวนการขึ้นทะเบียนแปลง (AVL) ของเกษตรกรที่สมัครเข้าเป็นสมาชิกเครือข่าย", type: 'item' },

    // ข้อ 5
    { label: "5. การฝึกอบรมเกษตรกรผู้ปลูก", type: 'header' },
    { label: "- ด้านการใช้สารเคมี", type: 'item', isSub: true },
    { label: "- ด้านการปนเปื้อนของสารเคมีและจุลินทรีย์", type: 'item', isSub: true },
    { label: "- โรคแมลงศัตรูพืชที่ติดกับผลผลิต", type: 'item', isSub: true },
    { label: "- ด้านการจัดการหลังเก็บเกี่ยว", type: 'item', isSub: true },

    // ข้อ 6
    { label: "6. อื่นๆ", type: 'header' },
    { label: "- พบแมลงศัตรูพืชในผลผลิตหลังการคัดแยกพร้อมส่งบริษัท", type: 'item', isSub: true },
    { label: "- สถานที่คัดแยกผลผลิตเสี่ยงต่อการปนเปื้อนเชื้อจุลินทรีย์", type: 'item', isSub: true },
    { label: "- สารเคมีนอกเหนือคำแนะนำของกรมวิชาการเกษตร", type: 'item', isSub: true },
    { label: "- ใช้สารเคมีที่ประเทศ EU ห้ามใช้", type: 'item', isSub: true },
    { label: "- ไม่จดบันทึก การใช้ปัจจัยการผลิตทางการเกษตร", type: 'item', isSub: true },
    { label: "- ไม่จดบันทึก ปริมาณผลผลิตและการจำหน่าย", type: 'item', isSub: true },
    { label: "- ไม่จดบันทึก การสำรวจโรคและแมลงในการปลูก", type: 'item', isSub: true },
];
...
// ฟังก์ชันสำหรับเลือก "ใช่/มี" ให้กับทุกรายการตรวจ
function yesAllDocuments() {
  cl02Items.forEach((item, index) => {
    if (item.type !== 'header') {
      cl02Form.answers[index] = 'yes';
    }
  });
}
</script>
