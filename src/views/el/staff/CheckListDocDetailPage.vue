            ...
            <v-row dense v-if="editType === 'farmer'">
              ...
              <v-col cols="12">
                ...
                >
                  <v-row dense align="center">
                    <v-col cols="12" md="4">
                      <v-checkbox
                        v-model="tempData.isAssignToProvince"
                        label="มอบหมายงานให้ ศวพ. จังหวัด"
                        color="el-staff"
                        hide-details
                        density="comfortable"
                      />
                    ...
                    <template v-if="tempData.isAssignToProvince">
                      ...
                      <v-col cols="12" md="4" class="d-flex align-center">
                        ...
                        <v-select
                          v-model="tempData.swpProvince"
                          :items="masterSwpProvinces"
                          variant="outlined"
                          rounded="lg"
                          density="compact"
                          hide-details
                  ...
                  <v-row justify="center" class="mt-8">
                    <v-radio-group
                      v-model="tempData.overallResult"
                      inline
                      hide-details
                    >
                      <v-radio
                  ...
                  <v-row class="mt-4">
                    <v-col cols="12">
                      ...
                      <v-textarea
                        v-model="tempData.overallRemark"
                        variant="outlined"
                        rounded="xl"
                        bg-color="white"
                        rows="3"
              ...
              <v-col cols="12">
                ...
                >
                  <v-table
                    density="comfortable"
                    class="bg-transparent custom-log-table"
                  >
                    <thead>
                      <tr class="bg-el-staff">
                        ...
                        <th class="text-center text-white" style="width: 150px">
                          วันที่
                        </th>
                        <th
                          class="text-left text-white"
                          style="border-radius: 0 12px 0 0"
                        >
                          หมายเหตุ
                        </th>
                      </tr>
                    ...
                    <tbody>
                      <tr
                        v-for="(log, index) in tempData.rejectionLog"
                        :key="index"
                      >
                      ...
                      <tr
                        v-if="
                          !tempData.rejectionLog ||
                          tempData.rejectionLog.length === 0
                        "
                      >
                        <td
                          colspan="4"
                          class="text-center text-medium-emphasis pa-6 italic"
                        >
                          <v-icon
