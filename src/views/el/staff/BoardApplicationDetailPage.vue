        ...
        <v-window v-model="page" :touch="false">
            ...
            <v-window-item value="main">
                <template v-if="currentStep === 0">
                    ...
                    <v-card rounded="xl" elevation="0" class="mb-5 section-card">
                        <v-card-title class="pa-5 pb-0 section-title font-weight-bold">4. ผลการตรวจ</v-card-title>
                        <v-card-text class="pa-5">
                    ...
                    <v-card rounded="xl" elevation="0" class="mb-5 section-card">
                        <v-card-title class="pa-5 pb-0 section-title font-weight-bold">5.ผลการพิจารณาโดยคณะกรรมการ
                            EL</v-card-title>
                        <v-card-text class="pa-5">
                            ...
                            <v-row dense align="center" class="mb-4">
                                ...
                                <v-col cols="12" md="4">
                                    <v-select v-model="tempData.committeeResult"
                                        ...
                                        rounded="lg" density="compact" hide-details placeholder="เลือกผลการพิจารณา" />
                                </v-col>
                            </v-row>
                            ...
                            <v-row dense align="center">
                                ...
                                <v-col cols="12" md="3">
                                    <v-text-field v-model="tempData.committeeRecorder" variant="outlined" rounded="lg"
                                ...
                                <v-col cols="12" md="3">
                                    <v-text-field v-model="tempData.committeeRecordDate" type="date" variant="outlined"
                                        rounded="lg" density="compact" hide-details />
                                </v-col>
                            </v-row>
                        </v-card-text>
                        <div class="d-flex justify-center mt-6 mb-6">
                            <v-btn color="success" prepend-icon="fas fa-arrow-left" rounded="lg"
                                class="px-8">ย้อนกลับ</v-btn>
                        </div>
                    </v-card>
                </template>
            </v-window-item>
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="item in cl02History" :key="item.id">
                                            <td class="text-center border-right">
                                                <v-btn icon="fas fa-edit" size="x-small" variant="text" color="primary"
