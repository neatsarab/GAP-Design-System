      ...
      <v-window-item value="form">
        <v-card rounded="xl" elevation="0" class="mb-5 section-card">
          ...
          <v-card-text class="pa-5">
            ...
            <v-card rounded="xl" elevation="0" class="mb-5 section-card">
              <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
                >2. ข้อมูลแปลงเกษตร</v-card-title
              >
              <v-card-text class="pa-5">
            ...
            <v-card rounded="xl" elevation="0" class="mb-5 section-card">
              <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
                >3. ผลการตรวจ</v-card-title
              >
              <v-card-text class="pa-5">
                <v-row dense align="center" class="mb-4">
                  <v-col cols="12" md="3" class="text-md-right pr-4"
                    >ผลการตรวจโรงคัดบรรจุ :</v-col
                  >
                  <v-col cols="12" md="3">
                    <v-select
                      v-model="evalData.factoryResult"
                      :items="['ผ่าน', 'ไม่ผ่าน']"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
                  ...
                  <v-col cols="12" md="3" class="text-md-right pr-4 mt-2"
                    >หมายเหตุ :</v-col
                  >
                  <v-col cols="12" md="9" class="mt-2">
                    <v-textarea
                      v-model="evalData.factoryRemark"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
                      rows="2"
                ...
                <v-row dense align="center">
                  <v-col cols="12" md="3" class="text-md-right pr-4"
                    >ผลการตรวจแปลงเกษตรกร :</v-col
                  >
                  <v-col cols="12" md="3">
                    <v-select
                      v-model="evalData.farmResult"
                      :items="['ผ่าน', 'ไม่ผ่าน']"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
            ...
            <v-card rounded="xl" elevation="0" class="mb-5 section-card">
              <v-card-title class="pa-5 pb-0 section-title font-weight-bold"
                >4.ผลการพิจารณาโดยคณะกรรมการ EL</v-card-title
              >
              <v-card-text class="pa-5">
                ...
                <v-row dense align="center" class="mb-4">
                  <v-col
                    cols="12"
                    md="3"
                    class="text-md-right pr-4 font-weight-bold"
                  >
                    ผลการพิจารณา :
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-select
                      v-model="tempData.committeeResult"
                      :items="['เห็นชอบ', 'ไม่เห็นชอบ', 'ขอข้อมูลเพิ่มเติม']"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
                      hide-details
                ...
                <v-row dense align="start" class="mb-4">
                  <v-col
                    cols="12"
                    md="3"
                    class="text-md-right pr-4 font-weight-bold pt-2"
                  >
                    หมายเหตุ :
                  </v-col>
                  <v-col cols="12" md="9">
                    <v-textarea
                      v-model="tempData.committeeRemark"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
                      rows="3"
                ...
                <v-row dense align="center" class="mb-4">
                  ...
                  <v-col cols="12" md="5">
                    <v-file-input
                      v-model="tempData.committeeFiles"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
                      hide-details
                      prepend-icon=""
                      append-inner-icon="fas fa-paperclip"
                      label="แนบเอกสารเพิ่มเติม (ถ้ามี)"
                      multiple
                    />
                  </v-col>
                </v-row>
                ...
                <v-row dense align="center">
                  ...
                  <v-col cols="12" md="3">
                    <v-text-field
                      v-model="tempData.committeeRecorder"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
                      hide-details
                  ...
                  <v-col cols="12" md="3">
                    <v-text-field
                      v-model="tempData.committeeRecordDate"
                      type="date"
                      variant="outlined"
                      rounded="lg"
                      density="compact"
      ...
      <v-window-item value="view-doa">
        <v-card rounded="xl" elevation="0" class="border pa-6">
          <v-row dense>
            ...
            <v-col cols="12" class="mt-n5">
              <div class="field-label mb-1 font-weight-bold text-success">
                แผนการเพาะปลูก
              </div>
              <v-divider class="mb-4" />
              <v-table
            ...
            <v-col cols="12" class="mt-6">
              <div class="field-label mb-2 font-weight-bold">
                ตรวจสอบเอกสารประกอบแปลงเกษตร
              </div>
              <v-table
                density="comfortable"
                class="border rounded-lg check-document-table"
              >
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr
                    v-for="(doc, index) in farmDocCheckList"
                    :key="index"
                    :class="{ 'bg-grey-lighten-4': doc.isHeader }"
                  >
                    <td class="pa-4" :class="{ 'pl-10': doc.isSub }">
                      <div class="text-body-2">
                        <span v-if="doc.required" class="text-error mr-1"
                          >*</span
                        >
                        {{ doc.label }}
                      </div>
                    ...
                    <td class="pa-2">
                      <v-textarea
                        v-if="!doc.isHeader"
                        v-model="tempData.checkRemarks[doc.key]"
                        variant="outlined"
                        rounded="lg"
                        density="compact"
                        hide-details
            ...
            <!-- ตารางรายการ CL-02 -->
            <v-col cols="12">
              <v-card rounded="lg" elevation="0" class="mb-5 overflow-hidden">
                <v-card-title
                  class="pa-0 border-bottom d-flex align-center bg-white"
                >
                  <!-- <v-btn color="el-staff" class="border-right rounded-0 elevation-0 px-2 py-2 mb-5"
                                        height="auto" @click="page = 'cl02-form'">
            ...
            <v-col cols="12">
              <v-card rounded="lg" elevation="0" class="pa-6 border mb-8">
                <h3 class="text-success mb-4 font-weight-bold">
                ...
                <div class="d-flex justify-center ga-3 mt-8">
                  <v-btn
                    ...
                    @click="saveMainData"
                  >
                    <v-icon icon="fas fa-save" class="mr-2" /> บันทึก
                  </v-btn>
                  <v-btn
                    variant="outlined"
                    rounded="lg"
          ...
          <v-row dense>
            ...
            <v-col cols="12">
              <v-card
                rounded="lg"
                elevation="0"
                class="mb-5 border overflow-hidden"
              >
                <!-- ส่วนหัว Tab Navigation -->
                <v-tabs
                  v-model="activeStep2Tab"
                  bg-color="grey-lighten-4"
                  color="el-staff"
                  align-tabs="start"
                >
                ...
                <v-window v-model="activeStep2Tab">
                        ...
                        <v-col cols="12">
                          ...
                          >
                            <thead class="bg-grey-lighten-3 text-center">
                              <tr>
                                <th class="border-right" style="width: 80px">
                                  ดู / แก้ไข
                                </th>
                  ...
                  <v-window-item value="ผลตรวจวิเคราะห์">
                    <v-container fluid class="pa-4">
                      <p class="text-center text-grey pa-10">
                        เนื้อหาผลตรวจวิเคราะห์
                      </p>
                    </v-container>
                  </v-window-item>
