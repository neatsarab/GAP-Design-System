...
function goToApplicationDetail(id) {
    router.push({ name: "ELStaffKtmWorkDetail", params: { id } });
}
...
const headers = [
    ...
    { title: "กลุ่มพืช", key: "typecert", sortable: true, width: '100px' },
