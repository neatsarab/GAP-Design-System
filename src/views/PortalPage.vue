<template>
  <div class="portal-root">
    ...
    <v-container class="portal-container d-flex flex-column align-center justify-center" fluid>
      ...
      <div class="text-center mb-10">
        ...
        <h1 class="text-h4 font-weight-bold mb-2">ระบบรับรองแหล่งผลิต GAP พืช</h1>
        <p class="text-body-1 text-medium-emphasis">กรมวิชาการเกษตร · กระทรวงเกษตรและสหกรณ์</p>
        <div class="d-flex justify-center ga-2 mt-3">
          <v-chip size="x-small" color="primary" variant="tonal">v1.0.0 MVP</v-chip>
          <v-chip size="x-small" color="success" variant="tonal" prepend-icon="fas fa-circle">พร้อมใช้งาน</v-chip>
        </div>
      </div>

      <!-- Menu Cards -->
      <v-row class="portal-cards justify-center" style="max-width:820px;width:100%">
          ...
          >
            <v-card-text class="pa-8 text-center d-flex flex-column align-center">
              ...
              <div class="d-flex flex-wrap justify-center ga-2 mb-6">
                <v-chip size="x-small" variant="tonal" color="primary" prepend-icon="fas fa-file-pen">ยื่นคำขอ</v-chip>
        ...
        <v-col cols="12" sm="6">
          ...
          >
            <v-card-text class="pa-8 text-center d-flex flex-column align-center">
              ...
              <p class="text-body-2 text-medium-emphasis mb-5">
                คู่มือ UI components, design tokens และแนวทางการออกแบบสำหรับระบบ GAP
              </p>
              <div class="d-flex flex-wrap justify-center ga-2 mb-6">
                <v-chip size="x-small" variant="tonal" color="secondary" prepend-icon="fab fa-vuejs">Vue 3</v-chip>
                <v-chip size="x-small" variant="tonal" color="info" prepend-icon="fas fa-puzzle-piece">Vuetify 3</v-chip>
                <v-chip size="x-small" variant="tonal" color="warning" prepend-icon="fas fa-code">TypeScript</v-chip>
              </div>
              <v-btn color="secondary" variant="elevated" prepend-icon="fas fa-arrow-right" size="large" rounded="lg" block>
                ดู Design System
              </v-btn>
            </v-card-text>
          </v-card>
...
.portal-bg-pattern {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse at 20% 50%, rgba(var(--v-theme-primary), 0.06) 0%, transparent 60%),
    radial-gradient(ellipse at 80% 20%, rgba(var(--v-theme-secondary), 0.05) 0%, transparent 50%);
  pointer-events: none;
}
