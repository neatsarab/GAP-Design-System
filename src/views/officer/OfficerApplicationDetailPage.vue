<template>
  <div>
    ...
    <div class="d-flex align-center ga-3 mb-5 flex-wrap">
      <v-btn variant="text" prepend-icon="fas fa-arrow-left" size="small" @click="router.push('/officer/applications')">
        กลับ
      </v-btn>
        ...
        <v-window-item :value="2">
          <v-card-text class="pa-5">
            ...
            <v-row v-if="app.currentStep === 2">
              <v-col cols="12" sm="4">
                <v-text-field v-model="scheduleForm.dateFrom" label="จากวันที่" type="date" />
              </v-col>
              <v-col cols="12" sm="4">
                <v-text-field v-model="scheduleForm.dateTo" label="ถึงวันที่" type="date" />
              </v-col>
              <v-col cols="12" sm="4">
                <v-text-field v-model="scheduleForm.inspector" label="ผู้รับผิดชอบตรวจ" prepend-inner-icon="fas fa-user-check" />
              </v-col>
              <v-col cols="12" sm="6">
                <v-textarea v-model="scheduleForm.note" label="หมายเหตุ / คำแนะนำสำหรับผู้ยื่นคำขอ" rows="3" />
              </v-col>
            </v-row>
        ...
        <v-window-item :value="3">
          <v-card-text class="pa-5">
            ...
            <v-row v-if="app.currentStep === 3">
              ...
              <v-col cols="12" sm="6">
                <v-text-field v-model="inspectionForm.inspectorName" label="ชื่อผู้ตรวจประเมิน" prepend-inner-icon="fas fa-user-check" />
              </v-col>
              <v-col cols="12" sm="6">
                <v-textarea
                  v-model="inspectionForm.defects"
                  label="ข้อบกพร่องที่พบ (ถ้ามี)"
                  rows="3"
              ...
              <v-col cols="12" sm="6">
                <v-textarea
                  ...
                  label="ผลวิเคราะห์ตัวอย่างจาก Lab"
                  rows="3"
                  placeholder="ผลตรวจสารตกค้าง, คุณภาพดิน/น้ำ ฯลฯ"
                />
              </v-col>
              <v-col cols="12" sm="6">
                <v-text-field v-model="inspectionForm.inspectedDate" label="วันที่ตรวจ" type="date" />
              </v-col>
            </v-row>
        ...
        <v-window-item :value="4">
          <v-card-text class="pa-5">
            ...
            <v-row v-if="app.currentStep === 4">
              ...
              <v-col cols="12" sm="4">
                <v-text-field v-model="ccProposeForm.meetingDate" label="วันที่นัดประชุม CC" type="date" />
              </v-col>
              <v-col cols="12" sm="6">
                <v-textarea v-model="ccProposeForm.summary" label="บทสรุปสำหรับคณะกรรมการ" rows="4" />
              </v-col>
            </v-row>
        ...
        <v-window-item :value="5">
          <v-card-text class="pa-5">
            ...
            <v-row v-if="app.currentStep === 5">
              <v-col cols="12" sm="4">
                <v-text-field v-model="ccResultForm.meetingDate" label="วันที่ประชุม CC" type="date" />
              </v-col>
              <v-col cols="12" sm="8">
                <v-select
              ...
              <v-col cols="12" sm="6">
                <v-textarea v-model="ccResultForm.notes" label="หมายเหตุ / เงื่อนไข" rows="3" />
              </v-col>
            </v-row>
          ...
          <v-card-text class="pa-5">
            ...
            <v-card variant="outlined" class="cert-preview mb-5">
              <v-card-text class="pa-5">
                ...
                <v-row>
                  <v-col cols="12" sm="4">
                    <v-text-field v-model="certForm.certNo"    label="เลขที่ใบรับรอง"  prepend-inner-icon="fas fa-hashtag" />
                  </v-col>
                  <v-col cols="12" sm="4">
                    <v-text-field v-model="certForm.issuedDate" label="วันที่ออกใบรับรอง" type="date" />
                  </v-col>
                  <v-col cols="12" sm="4">
                    <v-text-field v-model="certForm.expiryDate" label="วันหมดอายุ"       type="date" />
                  </v-col>
                  <v-col cols="12" sm="6">
                    <v-select
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field v-model="certForm.position" label="ตำแหน่ง" prepend-inner-icon="fas fa-user-shield" />
                  </v-col>
                </v-row>
              </v-card-text>
            </v-card>
    ...
    <v-dialog v-model="rejectDialog" max-width="480">
      <v-card rounded="xl">
        ...
        <v-card-text class="px-5 pb-3">
          <v-textarea v-model="rejectNote" label="ระบุเหตุผล / ข้อมูลที่ต้องแก้ไข" rows="4" />
