  ...
  <div>
    ...
    <v-row>
      ...
      <v-col cols="12" md="8">
        ...
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          <div class="section-header px-4 py-3 d-flex align-center ga-2">
            <v-icon icon="fas fa-file-invoice" color="hc-user" size="15" />
          ...
          <v-card-text class="pa-4">
            <v-row dense>
              ...
              <v-col cols="12" sm="6">
                ...
                <div class="info-value">ขอใบรับรอง</div>
              </v-col>
              <v-col cols="12" sm="6">
                <div class="field-label">
                ...
                <div class="info-value">18 ม.ค. 68</div>
              </v-col>
              <v-col cols="12" sm="6">
                <div class="field-label">
                ...
                <div class="info-value font-weight-bold text-hc-user">
                  500.00 บาท
                </div>
              </v-col>
            </v-row>
        ...
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          <div class="section-header px-4 py-3 d-flex align-center ga-2">
            <v-icon icon="fas fa-credit-card" color="hc-user" size="15" />
          ...
          <v-card-text class="pa-4">
            <v-radio-group v-model="paymentMethod" hide-details>
              <!-- <v-radio value="qr" color="hc-user">
                <template #label>
              ...
              <v-radio value="transfer" color="hc-user" class="mt-3">
                <template #label>
                  <div class="d-flex align-center ga-2 ml-1">
              ...
              <v-radio value="gateway" color="hc-user" class="mt-3">
                <template #label>
                  <div class="d-flex align-center ga-2 ml-1">
                    <v-icon icon="fas fa-file-pdf" size="18" />
                    <div>
                      <div class="font-weight-medium">ชำระที่เคาน์เตอร์ธนาคาร</div>
                      <div class="text-caption text-medium-emphasis">
            ...
            >
              <v-card
                ...
                width="220"
              >
                <v-icon icon="fas fa-qrcode" size="120" color="hc-user" />
                <div class="text-caption text-medium-emphasis mt-3 text-center">
                  สแกนเพื่อชำระ<br />
                  <span class="font-weight-bold text-hc-user">500.00 บาท</span>
                </div>
              </v-card>
            </div>
            ...
            >
              ...
              <v-row dense>
                ...
                <v-col cols="12" sm="6">
                  ...
                  <div class="text-body-2 font-weight-bold text-hc-user">
                    500.00 บาท
                  </div>
                </v-col>
              </v-row>
            ...
            <div v-if="paymentMethod === 'gateway'" class="mt-4">
              <!-- Bill preview -->
              <v-card rounded="xl" variant="outlined" class="mb-3 overflow-hidden">
                <div class="bill-header px-4 py-3 d-flex align-center ga-2">
                  <v-icon icon="fas fa-file-invoice-dollar" size="18" color="hc-user" />
                  <span class="font-weight-bold text-body-2">ใบแจ้งชำระเงินค่าธรรมเนียม</span>
                  <v-spacer />
                  <v-chip size="x-small" color="warning" variant="tonal">รอชำระเงิน</v-chip>
                </div>
                <v-divider />
                <div class="pa-4">
                  <v-row dense>
                    <v-col cols="6">
                      <div class="text-caption text-medium-emphasis">เลขอ้างอิง</div>
                      <div class="text-body-2 font-weight-bold text-hc-user">
                        REF-{{ route.params.id }}-01
                      </div>
                    </v-col>
                    <v-col cols="6">
                      <div class="text-caption text-medium-emphasis">ชำระภายใน</div>
                      <div class="text-body-2 font-weight-medium">30/04/2569</div>
                    </v-col>
                    <v-col cols="6" class="mt-2">
                      <div class="text-caption text-medium-emphasis">ชื่อผู้ชำระ</div>
                      <div class="text-body-2 font-weight-medium">บริษัท กรีนเฟรช จำกัด</div>
                    </v-col>
                    <v-col cols="6" class="mt-2">
                      <div class="text-caption text-medium-emphasis">รายการ</div>
                      <div class="text-body-2 font-weight-medium">ค่าธรรมเนียมคำขอ</div>
                    </v-col>
                  </v-row>
                  <v-divider class="my-3" />
                  <div class="d-flex justify-space-between align-center">
                    <span class="text-body-2 text-medium-emphasis">ยอดที่ต้องชำระ</span>
                    <span class="text-h6 font-weight-bold text-hc-user">500.00 บาท</span>
                  </div>
                  <v-divider class="my-3" />
                  <div class="text-caption text-medium-emphasis mb-1">ธนาคารที่รับชำระ</div>
                  <div class="d-flex align-center ga-2">
                    <v-icon icon="fas fa-building-columns" size="14" color="hc-user" />
                    <span class="text-body-2">ธนาคารกรุงไทย ทุกสาขาทั่วประเทศ</span>
                  </div>
                </div>
              </v-card>
              <v-btn
              ...
              <p class="text-caption text-medium-emphasis text-center mt-2">
                นำใบแจ้งชำระเงินไปชำระที่ธนาคารกรุงไทยทุกสาขา จากนั้นแนบสลิปด้านล่าง
              </p>
            </div>
          </v-card-text>
        </v-card>
        ...
        <v-card rounded="xl" elevation="0" class="section-card">
          <div class="section-header px-4 py-3 d-flex align-center ga-2">
            <v-icon icon="fas fa-upload" color="hc-user" size="15" />
            <span class="text-subtitle-2 font-weight-bold"
      ...
      <v-col cols="12" md="4">
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          <div class="section-header px-4 py-3 d-flex align-center ga-2">
            <v-icon icon="fas fa-receipt" color="hc-user" size="15" />
            <span class="text-subtitle-2 font-weight-bold"
          ...
          <v-card-text class="pa-4">
            ...
            <div class="d-flex justify-space-between align-center">
              ...
              <span class="font-weight-bold text-hc-user text-h6"
                >500.00 บาท</span
              >
            </div>
          </v-card-text>
      ...
      <v-card rounded="xl">
        ...
        <v-card-actions class="px-6 pb-5 pt-0">
          <v-btn
            ...
            variant="flat"
            rounded="lg"
            @click="router.push({ name: 'HCUserApplicationList' })"
