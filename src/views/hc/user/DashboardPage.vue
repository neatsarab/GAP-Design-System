    ...
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-6">
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          ภาพรวมระบบออกใบรับรองสุขอนามัยพืช (Health Certificate)
        </p>
      </div>
      <v-btn
        color="hc-user"
              ...
              >
                <template #prepend>
                  <v-avatar
                    ...
                    class="mr-3"
                  >
                    <v-icon icon="fas fa-virus" size="18" />
                  </v-avatar>
                </template>
      ...
      <v-col cols="12" md="4">
        ...
        >
          ...
          <div class="text-body-2">
            คำขอ HC-2568-00002 อยู่ระหว่างการตรวจสอบ Lab
          </div>
        </v-alert>
        <v-card rounded="xl" elevation="0">
          <v-card-title class="d-flex align-center ga-2 pa-4 pb-3">
...
const stats = [
  { label: "คำขอทั้งหมด", value: 4, icon: "fas fa-file-lines", iconColor: "hc-user" },
...
const recentApplications = [
  { id: "HC-2568-00003", requestNo: "HC-2568-00003", submittedDate: "5 มี.ค. 2568", status: "under_review" },
  { id: "HC-2568-00002", requestNo: "HC-2568-00002", submittedDate: "20 ก.พ. 2568", status: "inspection_scheduled" },
  { id: "HC-2568-00001", requestNo: "HC-2568-00001", submittedDate: "10 ม.ค. 2568", status: "approved" },
];

const quickActions = [
  { title: "ยื่นคำขอใหม่", icon: "fas fa-file-pen", color: "primary", to: "/hc/user/applications/new" },
  { title: "รายการคำขอ", icon: "fas fa-file-lines", color: "primary", to: "/hc/user/applications" },
];
