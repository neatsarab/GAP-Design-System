    ...
    <v-card>
      ...
      >
        <template #item.certNo="{ item }">
          <span class="text-body-2 font-weight-bold text-info">{{ item.certNo }}</span>
        </template>
...
const certStats = [
  { label: "ใบรับรองมีผล",  icon: "fas fa-circle-check",  color: "success", value: 4 },
  { label: "ใกล้หมดอายุ",   icon: "fas fa-clock",          color: "warning", value: 1 },
  { label: "หมดอายุแล้ว",   icon: "fas fa-circle-xmark",   color: "error",   value: 2 },
  { label: "ทั้งหมด",        icon: "fas fa-certificate",    color: "info",    value: 7 },
];
...
const certs: Cert[] = [
  { certNo: "THHC-2568-00025", requestNo: "HC-2568-00025", product: "มังคุด",    destination: "จีน",          issuedAt: "10 ม.ค. 68", expiry: "10 ม.ค. 69", certStatus: "active"   },
  { certNo: "THHC-2568-00022", requestNo: "HC-2568-00022", product: "กล้วยหอม",  destination: "ญี่ปุ่น",       issuedAt: "8 ม.ค. 68",  expiry: "8 ม.ค. 69",  certStatus: "active"   },
  { certNo: "THHC-2568-00018", requestNo: "HC-2568-00018", product: "มะม่วง",    destination: "ญี่ปุ่น",       issuedAt: "20 ธ.ค. 67", expiry: "20 ธ.ค. 68", certStatus: "expiring" },
  { certNo: "THHC-2567-00098", requestNo: "HC-2567-00098", product: "ลำไย",      destination: "จีน",          issuedAt: "5 ม.ค. 67",  expiry: "5 ม.ค. 68",  certStatus: "expired"  },
  { certNo: "THHC-2568-00030", requestNo: "HC-2568-00030", product: "ทุเรียน",   destination: "เกาหลีใต้",    issuedAt: "15 ม.ค. 68", expiry: "15 ม.ค. 69", certStatus: "active"   },
  { certNo: "THHC-2568-00015", requestNo: "HC-2568-00015", product: "ส้มโอ",     destination: "สิงคโปร์",     issuedAt: "10 ธ.ค. 67", expiry: "10 ธ.ค. 68", certStatus: "active"   },
  { certNo: "THHC-2567-00080", requestNo: "HC-2567-00080", product: "กระเทียม",  destination: "เกาหลีใต้",    issuedAt: "1 มิ.ย. 67", expiry: "1 มิ.ย. 68", certStatus: "expired"  },
];
