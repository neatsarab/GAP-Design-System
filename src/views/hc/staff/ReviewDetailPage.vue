...
<body>
  <div class="border-box">
    ...
    <div class="grid">
      <div>
        <div class="label">ชื่อผู้ส่งออก (ไทย)</div>
        <div class="value">${app.cbNameTh}</div>
      </div>
      <div>
        <div class="label">Exporter Name (English)</div>
...
const app = {
  ...
  cbNameTh: "บริษัท ไทยฟรุ๊ต จำกัด",
  cbNameEn: "Thai Fruit Co., Ltd.",
  cbPhone: "02-456-7890",
  cbFax: "02-456-7891",
  cbEmail: "info@thaifruit.co.th",
