    ...
    <div class="d-flex align-center ga-3 mb-6">
      ...
      <div class="flex-grow-1">
        ...
        <p class="text-body-2 text-medium-emphasis mb-0 mt-1">
          {{ app.applicant }} · ยื่นเมื่อ {{ app.submittedDate }}
        </p>
      </div>
    </div>
        ...
        <v-col cols="12" md="8">
            ...
            <v-card-text class="pa-5">
              <v-row dense>
                <v-col cols="12" sm="6"
                  ...
                  <div class="info-value">{{ app.applicant }}</div></v-col
                >
                <v-col cols="12" sm="6"
                ...
                <v-col cols="12" sm="6"
                  ...
                  <div class="info-value">contact@example.com</div></v-col
                >
                <v-col cols="12"
                  ><div class="info-label">ที่อยู่</div>
                  <div class="info-value">
                    123 ถนนพหลโยธิน แขวงลาดยาว เขตจตุจักร กรุงเทพฯ 10900
                  </div></v-col
                >
              </v-row>
            </v-card-text>
          ...
          <v-card rounded="xl" elevation="0" class="section-card mb-4">
            ...
            <v-card-text class="pa-5">
              <v-row dense>
                <v-col cols="12"
                  ><div class="info-label">ที่อยู่สำนักงาน</div>
                  <div class="info-value">
                ...
                <v-col cols="12" sm="6"
                  ><div class="info-label">โทรศัพท์</div>
                  <div class="info-value">02-987-6543</div></v-col
                >
                <v-col cols="12" sm="6"
                  ><div class="info-label">โทรสาร</div>
                  <div class="info-value">02-987-6544</div></v-col
                >
              </v-row>
            </v-card-text>
          </v-card>
          ...
          <v-card rounded="xl" elevation="0" class="section-card mb-5">
            ...
            <v-card-text class="pa-5">
              ...
              <div class="field-label mb-1">
                ...
                <div class="field-label-en">Action Status</div>
              </div>
              <v-radio-group
                v-model="sign.actionStatus"
                color="cb-staff"
                class="mb-4"
              >
              ...
              <v-row dense>
                ...
                <v-col cols="12" class="mt-3">
                  <div class="field-label mb-1">
                    <div>พืช</div>
                    <div class="field-label-en">Crop</div>
                  </div>
                  <v-autocomplete
              ...
              <div class="d-flex align-center justify-space-between">
                <div>
                  ...
                  <div class="text-caption text-medium-emphasis mt-1">
                    {{
                      sign.active
                        ? "ใบรับรองมีผลบังคับใช้"
                        : "ใบรับรองถูกระงับการใช้งาน"
                    }}
                  </div>
                </div>
                <v-switch
            ...
            <v-card-text class="pa-5">
              <v-row dense>
                <v-col cols="12"
                  ...
                  <div class="info-value">{{ app.requestNo }}</div></v-col
                >
                <v-col cols="12"
                ...
                <v-col cols="12"
                  ...
                  <div class="info-value">{{ typeLabel(app.type) }}</div></v-col
                >
              </v-row>
            </v-card-text>
          </v-card>
      ...
      <v-card rounded="xl">
        <v-card-text class="pa-7 text-center">
          ...
          <p class="text-body-2 text-medium-emphasis">
            ยืนยันการดำเนินการและบันทึกผลการพิจารณาใช่หรือไม่?
          </p>
        </v-card-text>
        <v-card-actions class="px-6 pb-5 ga-2">
          <v-btn
            ...
            >ยกเลิก</v-btn
          >
          <v-btn color="cb-staff" rounded="lg" block @click="doSave"
            >ยืนยัน</v-btn
          >
        </v-card-actions>
      </v-card>
