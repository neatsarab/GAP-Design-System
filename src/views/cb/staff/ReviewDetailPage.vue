<template>
  <div style="--v-theme-primary: var(--v-theme-cb-staff)">
    ...
    <v-row>
      <v-col cols="12" md="8">
        <v-tabs v-model="activeTab" color="cb-staff" class="mb-4">
                ...
                <v-row dense>
                  ...
                  <v-col cols="6" md="4">
                    ...
                    <div class="info-value">
                      <v-chip size="x-small" color="cb-staff" variant="tonal">{{
                        app.requestType
                      }}</v-chip>
                    </div>
                  </v-col>
            ...
            <v-card rounded="xl" elevation="0" class="section-card">
              <v-card-text class="pa-5">
                ...
                <div class="text-caption text-medium-emphasis mb-2">
                  ...
                  ระบบสร้างเลขทะเบียนให้อัตโนมัติ — สามารถแก้ไขได้ก่อนยืนยัน
                </div>
      ...
      <v-card rounded="xl">
        <v-card-text class="pa-7 text-center">
          ...
          <p class="text-body-2 text-medium-emphasis">
            ยืนยันการส่งคำขอนี้ไปยังขั้นตอนลงนามใช่หรือไม่?
          </p>
        </v-card-text>
    ...
    <v-dialog v-model="successDialog" max-width="420" persistent>
      <v-card rounded="xl">
        ...
        <v-card-actions class="px-6 pb-5">
          <v-btn color="cb-staff" rounded="lg" block @click="goToReviewList"
...
function goToReviewList() {
  router.push({ name: "CBStaffReviewList" });
}
...
<head>
  <meta charset="UTF-8" />
  <title>ตัวอย่างใบทะเบียน ${no}</title>
  <style>
...
<body>
  <div class="border-box">
    <div class="center">
      ...
      <div style="font-size:16pt;font-weight:700;margin:8px 0">หนังสือสำคัญแสดงการขึ้นทะเบียนหน่วยรับรองโรงงานผลิตสินค้าพืช</div>
      <div class="label">Certificate of Certification Body Registration</div>
    ...
    <div class="grid">
      <div>
        ...
        <div class="value">${app.cbNameTh}</div>
      </div>
      <div>
        <div class="label">Company Name (English)</div>
        <div class="value">${app.cbNameEn}</div>
      </div>
      <div>
