    ...
    <v-tabs-window v-model="activeTab">
      ...
      <v-tabs-window-item value="individual">
        <v-form ref="formIndividual" @submit.prevent="submitIndividual">
                  ...
                  <v-row dense>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        ...
                        <div class="field-label-en">ID Card</div>
                      </div>
                      <v-text-field
                        v-model="ind.idCard"
                        variant="outlined"
                ...
                <v-card-text class="pa-5">
                  <v-row dense>
                    ...
                    <v-col cols="6" sm="3" md="2">
                      <div class="field-label">
                        <div>จำนวนแปลง</div>
                        <div class="field-label-en">Plots</div>
                      </div>
                      <v-text-field
                        v-model="ind.plotCount"
                        type="number"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>จังหวัดที่ตั้งแปลง</div>
                        <div class="field-label-en">Plot Province</div>
                      </div>
                      <v-autocomplete
                        v-model="ind.plotProvince"
                        :items="provinces"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ตำบล / อำเภอ</div>
                        <div class="field-label-en">Subdistrict / District</div>
                      </div>
                      <v-text-field
                        v-model="ind.subDistrict"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                        hide-details
                    ...
                    <v-col cols="6" sm="3" md="2">
                      <div class="field-label">
                        <div>Lat</div>
                        <div class="field-label-en">Latitude</div>
                      </div>
                      <v-text-field
                        v-model="ind.lat"
                        variant="outlined"
                    ...
                    <v-col cols="6" sm="3" md="2">
                      <div class="field-label">
                        <div>Long</div>
                        <div class="field-label-en">Longitude</div>
                      </div>
                      <v-text-field
                        v-model="ind.lng"
                        variant="outlined"
              ...
              <v-card rounded="xl" elevation="0" class="mb-4">
                ...
                <v-card-text class="pa-5">
                  <v-row dense>
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ประเภทการขอรับรอง</div>
                        <div class="field-label-en">Request Type</div>
                      </div>
                      <v-autocomplete
                        v-model="ind.requestType"
                        :items="indRequestTypes"
                        item-title="label"
                        item-value="value"
                        variant="outlined"
                        density="compact"
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>มาตรฐานที่ขอรับรอง</div>
                        <div class="field-label-en">Standard</div>
                      </div>
                      <v-autocomplete
                        v-model="ind.standard"
                        :items="standards"
                        item-title="label"
                        item-value="value"
                        variant="outlined"
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ปีการผลิต</div>
                        <div class="field-label-en">Production Year</div>
                      </div>
                      <v-text-field
                        v-model="ind.productionYear"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                        hide-details
                    ...
                    <v-col cols="12">
                      <div class="field-label">
                        <div>หมายเหตุ</div>
                        <div class="field-label-en">Note</div>
                      </div>
                      <v-textarea
                        v-model="ind.note"
                        variant="outlined"
          ...
          <div class="d-flex justify-end ga-3 mt-2">
            <v-btn variant="tonal" color="grey" @click="resetIndividual"
              >ล้างข้อมูล</v-btn
            >
            <v-btn
              color="org-staff"
      ...
      <v-tabs-window-item value="group">
        <v-form ref="formGroup" @submit.prevent="submitGroup">
              ...
              <v-card rounded="xl" elevation="0" class="mb-4">
                ...
                <v-card-text class="pa-5">
                  <v-row dense>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ชื่อประธานกลุ่ม</div>
                        <div class="field-label-en">Group Leader</div>
                      </div>
                      <v-text-field
                        v-model="grp.leader"
                        variant="outlined"
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>เบอร์โทรศัพท์ประธาน</div>
                        <div class="field-label-en">Leader Phone</div>
                      </div>
                      <v-text-field
                        v-model="grp.leaderPhone"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                        hide-details
                    ...
                    <v-col cols="12">
                      <div class="field-label">
                        <div>ที่อยู่กลุ่ม</div>
                        <div class="field-label-en">Group Address</div>
                      </div>
                      <v-text-field
                        v-model="grp.address"
                        variant="outlined"
                ...
                <v-card-text class="pa-5">
                  <v-row dense>
                    ...
                    <v-col cols="6" sm="3" md="2">
                      <div class="field-label">
                        <div>จำนวนสมาชิก</div>
                        <div class="field-label-en">Members</div>
                      </div>
                      <v-text-field
                        v-model="grp.memberCount"
                        type="number"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                    ...
                    <v-col cols="6" sm="3" md="2">
                      <div class="field-label">
                        <div>จำนวนแปลงรวม</div>
                        <div class="field-label-en">Total Plots</div>
                      </div>
                      <v-text-field
                        v-model="grp.totalPlots"
                        type="number"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ชนิดพืชหลัก</div>
                        <div class="field-label-en">Main Crop</div>
                      </div>
                      <v-combobox
                        v-model="grp.cropType"
                        :items="cropTypes"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                    ...
                    <v-col cols="6" sm="3" md="2">
                      <div class="field-label">
                        <div>พื้นที่รวม (ไร่)</div>
                        <div class="field-label-en">Total Area</div>
                      </div>
                      <v-text-field
                        v-model="grp.totalArea"
                        type="number"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
          ...
          <div class="d-flex justify-end ga-3 mt-2">
            <v-btn variant="tonal" color="grey" @click="resetGroup"
              >ล้างข้อมูล</v-btn
            >
            <v-btn
              color="org-staff"
      ...
      <v-tabs-window-item value="correction">
        <v-form ref="formCorrection" @submit.prevent="submitCorrection">
                  ...
                  <v-row dense>
                    <v-col cols="12" sm="6" md="4">
                      ...
                      <v-text-field
                        ...
                        rounded="lg"
                        hide-details
                        placeholder="GAP-CERT-2569-XXXXX"
                        :rules="[required]"
                      />
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ชื่อเกษตรกร / กลุ่ม</div>
                        <div class="field-label-en">Farmer / Group Name</div>
                      </div>
                      <v-text-field
                        v-model="cor.farmerName"
                        variant="outlined"
                        density="compact"
                        rounded="lg"
                        hide-details
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <div class="field-label">
                        <div>ประเภทการแก้ไข</div>
                        <div class="field-label-en">Correction Type</div>
                      </div>
                      <v-autocomplete
                        v-model="cor.correctionType"
                    ...
                    <v-col cols="12">
                      <div class="field-label">
                        <div>รายการที่ต้องการแก้ไข</div>
                        <div class="field-label-en">Items to Correct</div>
                      </div>
                      <v-textarea
                        v-model="cor.correctionDetail"
                        variant="outlined"
                        rounded="lg"
                        hide-details
                        rows="3"
                        placeholder="ระบุรายการที่ต้องการแก้ไข เช่น แก้ไขชื่อเกษตรกร / เพิ่มพื้นที่แปลง"
                        :rules="[required]"
                      />
                    </v-col>
                    <v-col cols="12">
                      <div class="field-label">
                        ...
                        <div class="field-label-en">Additional Note</div>
                      </div>
                      <v-textarea
                        v-model="cor.note"
                        variant="outlined"
          ...
          <div class="d-flex justify-end ga-3 mt-2">
            <v-btn variant="tonal" color="grey" @click="resetCorrection"
              >ล้างข้อมูล</v-btn
            >
            <v-btn
              color="org-staff"
...
function submitIndividual() {
  snackbar.value = true;
  setTimeout(() => goToApplicationList(), 1500);
}
