    ...
    <div class="d-flex align-center ga-3 mb-4">
      ...
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0 mt-1">
          เลขทะเบียน:
          <span class="text-org-staff font-weight-medium">{{
            route.params.id
          }}</span>
        </p>
      </div>
    ...
    <v-row>
      ...
      <v-col cols="12" md="8">
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          ...
          >
            <v-icon icon="fas fa-file-pen" color="org-staff" size="15" />
            ...
            >
              ...
              <v-radio value="cancel">
                <template #label>
                  <div class="d-flex align-center ga-2">
                    <v-icon icon="fas fa-ban" color="error" size="18" />
                    <span class="font-weight-medium">ยกเลิก</span>
                  </div>
                </template>
              </v-radio>
            </v-radio-group>
...
const actionColor = computed(
  () => actionMap[form.action]?.color ?? "org-staff",
);
