    ...
    <div class="d-flex align-center justify-space-between mb-5 flex-wrap ga-3">
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          รายการผู้ผ่านการรับรองมาตรฐานเกษตรอินทรีย์ทั้งหมด
        </p>
      </div>
      <v-btn variant="tonal" color="org-staff" prepend-icon="fas fa-download"
        >ส่งออก Excel</v-btn
      >
    </div>
      ...
      <v-card-text class="pa-4">
        <v-row dense align="center">
          <v-col cols="12" sm="5">
            ...
            <v-text-field
              v-model="search"
              placeholder="ค้นหาเลขทะเบียน / ชื่อ / จังหวัด"
    ...
    <v-card rounded="xl" elevation="0" class="data-card">
      ...
      >
        ...
        <template #item.type="{ item }">
          <v-chip size="x-small" color="org-staff" variant="tonal">{{
            item.type
          }}</v-chip>
        </template>
...
const items = [
  {
    regNo: "ORG-2569-00012",
    name: "นายสมศักดิ์ เกษตรดี",
    type: "รายบุคคล",
    cropType: "ข้าว",
    province: "สุรินทร์",
  ...
  {
    regNo: "ORG-2569-00008",
    name: "กลุ่มเกษตรอินทรีย์บ้านโนน",
    type: "กลุ่มเกษตรกร",
    cropType: "ผัก",
  ...
  {
    regNo: "ORG-2569-00005",
    name: "บริษัท ออร์แกนิคไทย จำกัด",
    type: "นิติบุคคล",
    cropType: "ผลไม้",
    province: "เชียงราย",
  ...
  {
    regNo: "ORG-2569-00031",
    name: "นางสาวพิมพ์ใจ ธรรมชาติ",
    type: "รายบุคคล",
    cropType: "สมุนไพร",
    province: "เลย",
  ...
  {
    regNo: "ORG-2569-00003",
    name: "วิสาหกิจชุมชนเกษตรอินทรีย์",
    type: "กลุ่มเกษตรกร",
    cropType: "ข้าว",
    province: "ยโสธร",
    registeredDate: "15 ม.ค. 68",
    expireDate: "15 ม.ค. 71",
    certStatus: "active",
  },
  {
    regNo: "ORG-2569-00001",
    name: "นายประสิทธิ์ พืชผล",
    type: "รายบุคคล",
    cropType: "ชา",
    province: "เชียงใหม่",
