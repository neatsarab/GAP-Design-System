    ...
    <div class="d-flex align-center ga-3 mb-6 flex-wrap">
      ...
      <div class="flex-grow-1">
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          ยื่นเมื่อ {{ app.submittedDate }} · ผู้ยื่น {{ app.applicantName }}
        </p>
      </div>
      ...
      <v-col cols="12" md="8">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                ><span class="info-value">{{
                  app.type === "individual" ? "รายเดี่ยว" : "รายกลุ่ม"
                }}</span>
              </div>
            </div>
          </v-card-text>
        ...
        <v-card rounded="xl" elevation="0" class="mb-4">
          ...
          <v-card-text class="pa-4">
            <v-row dense class="mb-4">
              <v-col cols="6" sm="3"
                ><div class="info-stat">
                  <div class="text-h6 font-weight-bold text-org-staff">
                    {{ app.area }}
                  </div>
        ...
        >
          <div class="section-header">
            ...
            <span class="text-subtitle-2 font-weight-bold"
              >Step 1 — ตรวจสอบข้อมูลคำขอ</span
            >
          </div>
          <v-card-text class="pa-4">
            <div class="field-label mb-1">
              ผลการตรวจสอบ <span class="req">*</span>
            </div>
          ...
          <v-card-actions class="pa-4 pt-0 ga-2">
            ...
            >
            <v-btn
              v-if="step1.result === 'pass'"
              color="org-staff"
              rounded="lg"
              prepend-icon="fas fa-arrow-right"
              @click="advanceStep"
              >ส่งต่อตรวจแปลง</v-btn
            >
          </v-card-actions>
        </v-card>
        ...
        >
          ...
          <v-card-text class="pa-4">
            <v-row dense>
              <v-col cols="12" sm="6">
                <div class="field-label mb-1">
                  วันที่นัดตรวจ <span class="req">*</span>
                </div>
                <v-text-field
                  v-model="step2.inspectionDate"
                  type="date"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
        ...
        >
          ...
          <v-card-text class="pa-4">
            <v-row dense>
              <v-col cols="12" sm="6">
                <div class="field-label mb-1">
                  ชนิดพืชที่พบ <span class="req">*</span>
                </div>
                <v-text-field
                  v-model="step3.cropFound"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
                  hide-details
              ...
              <v-col cols="12" sm="6">
                <div class="field-label mb-1">
                  พื้นที่จริง (ไร่) <span class="req">*</span>
                </div>
                <v-text-field
                  v-model="step3.actualArea"
                  type="number"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
              ...
              <v-col cols="12" sm="6">
                <div class="field-label mb-1 mt-3">
                  ปริมาณผลผลิตที่คาดการณ์ (กก.)
                </div>
                <v-text-field
                  v-model="step3.expectedYield"
                  type="number"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
              ...
              <v-col cols="12">
                <div class="field-label mb-1 mt-3">
                  ผลการตรวจแปลง <span class="req">*</span>
                </div>
                <v-radio-group v-model="step3.result" inline class="mt-0">
                  <v-radio label="ผ่าน" value="pass" color="success" />
                  <v-radio
                    label="พบข้อบกพร่อง (ต้องแก้ไข)"
                    value="defect"
                    color="warning"
                  />
                  <v-radio label="ไม่ผ่าน" value="fail" color="error" />
        ...
        >
          <div class="section-header">
            ...
            <span class="text-subtitle-2 font-weight-bold"
              >Step 4 — เสนอต่อคณะกรรมการ (CC)</span
            >
          </div>
          <v-card-text class="pa-4">
            <v-row dense>
              <v-col cols="12" sm="6">
                <div class="field-label mb-1">
                  วันที่เสนอ CC <span class="req">*</span>
                </div>
                <v-text-field
                  v-model="step4.ccDate"
                  type="date"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
              ...
              <v-col cols="12">
                ...
                <v-textarea
                  v-model="step4.summary"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
                  rows="3"
                  hide-details
                  placeholder="สรุปข้อมูลที่จะเสนอต่อคณะกรรมการ"
                />
              </v-col>
            </v-row>
          </v-card-text>
        ...
        >
          <div class="section-header">
            <v-icon icon="fas fa-clipboard-check" color="org-staff" size="15" />
            <span class="text-subtitle-2 font-weight-bold"
              >Step 5 — บันทึกผลจาก CC</span
            >
          </div>
          <v-card-text class="pa-4">
            <div class="field-label mb-1">
              ผลการพิจารณาจาก CC <span class="req">*</span>
            </div>
            <v-select
              v-model="step5.ccResult"
              :items="ccResultOptions"
              item-title="label"
              item-value="value"
              variant="outlined"
              density="compact"
          ...
          <v-card-actions class="pa-4 pt-0 ga-2">
            ...
            >
            <v-btn
              v-else-if="step5.ccResult === 'rejected'"
              color="error"
              rounded="lg"
              prepend-icon="fas fa-circle-xmark"
              @click="actionReject"
        ...
        >
          <div class="section-header">
            ...
            <span class="text-subtitle-2 font-weight-bold"
              >Step 6 — ลงนามและออกใบรับรอง</span
            >
          </div>
          <v-card-text class="pa-4">
            <v-row dense>
              <v-col cols="12" sm="6">
                <div class="field-label mb-1">
                  ผู้มีอำนาจลงนาม <span class="req">*</span>
                </div>
                <v-text-field
                  v-model="step6.signer"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
                  hide-details
              ...
              <v-col cols="12" sm="6">
                <div class="field-label mb-1">
                  วันที่ลงนาม <span class="req">*</span>
                </div>
                <v-text-field
                  v-model="step6.signedDate"
                  type="date"
                  variant="outlined"
                  density="compact"
                  rounded="lg"
          ...
          <v-card-text class="pa-4">
            ...
            >
              ...
              >
                <div
                  class="event-dot"
                  :style="`background:rgb(var(--v-theme-${ev.color}))`"
                />
