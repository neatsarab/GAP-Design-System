<template>
    <div>
        <div class="d-flex align-center justify-space-between mb-5 flex-wrap ga-3">
            <div>
                <h1 class="page-title mb-1">ใบรับรอง ORG</h1>
                <p class="text-body-2 text-medium-emphasis mb-0">รายการใบรับรองมาตรฐานเกษตรอินทรีย์</p>
            </div>
            <v-btn variant="flat" color="org-user" prepend-icon="fas fa-plus">ยื่นคำขอใหม่</v-btn>
        </div>
        ...
        <v-card rounded="xl" elevation="0" class="data-card border">
            <v-data-table :headers="headers" :items="filteredCerts" hover class="gap-table">
                <template #item.qrcode>
                    <v-icon icon="fas fa-qrcode" color="org-user" size="18" />
                </template>
                ...
                <template #item.actions>
                    <v-btn icon="fas fa-eye" size="x-small" variant="text" color="org-user" />
                </template>
            </v-data-table>
        </v-card>
    </div>
