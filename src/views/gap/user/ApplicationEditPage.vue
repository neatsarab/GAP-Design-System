                                ...
                                <v-table density="compact" class="inspection-table">
                                    ...
                                    <tbody>
                                        <tr v-for="(item, index) in application.inspections" :key="index">
                                            ...
                                            <td class="text-center">
                                                <v-btn color="gap-user" variant="tonal" size="small" rounded="lg"
                                                    @click="goToEdit(item)">
                                                    แก้ไข
                                                </v-btn>
                                            </td>
                        ...
                        <v-card rounded="xl" elevation="0" class="section-card mb-4">
                            ...
                            <v-card-text class="pa-6">
                                ...
                                <div class="d-flex justify-end ga-3">
                                    ...
                                    <v-btn color="gap-user" elevation="0" rounded="xl" class="text-white"
        ...
        <v-dialog v-model="activityDetailDialog" max-width="420">
            <v-card rounded="xl">
                ...
                <v-card-actions class="px-6 pb-5 pt-0">
                    <v-btn color="gap-user" variant="tonal" rounded="lg" block @click="activityDetailDialog = false">
                        ปิด
                    </v-btn>
                </v-card-actions>
            </v-card>
