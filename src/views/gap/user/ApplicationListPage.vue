<template>
    <div>
        <div class="d-flex align-center justify-space-between mb-6 flex-wrap ga-3">
            ...
            <v-btn color="gap-user" prepend-icon="fas fa-plus" @click="goToNewApplication">
                ยื่นคำขอใหม่
            </v-btn>
        </div>
                ...
                <template #item.actions="{ item }">
                    <div class="d-flex align-center ga-1">
                        ...
                        <v-tooltip text="ดูรายละเอียด" location="top">
                            <template #activator="{ props }">
                                <v-btn v-bind="props" icon size="x-small" variant="text" color="gap-user"
        ...
        <v-dialog v-model="noteDialog" max-width="480">
            <v-card rounded="xl">
                <v-card-title class="d-flex align-center ga-2 pa-5 pb-3">
                    ...
                    <v-chip v-if="noteItem" size="x-small" variant="tonal" color="gap-user" class="ml-1">{{
                        noteItem.requestNo
                        }}</v-chip>
                    <v-spacer />
