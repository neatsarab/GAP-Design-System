    ...
    <div class="d-flex align-center ga-3 mb-4">
      ...
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0 mt-1">
          เลขคำขอ:
          <span class="text-gap-user font-weight-medium">{{
    ...
    <v-row>
      ...
      <v-col cols="12" md="8">
        ...
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          ...
          >
            <v-icon icon="fas fa-list-check" color="gap-user" size="15" />
          ...
          <v-card-text class="pa-4">
            <v-row dense>
              <v-col cols="6" md="4">
                ...
                <div class="info-value text-gap-user font-weight-bold">
        ...
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          <div
            class="section-header px-4 py-3 border-b d-flex align-center ga-2"
          >
            <v-icon icon="fas fa-building" color="gap-user" size="15" />
            <span class="text-subtitle-2 font-weight-bold"
        ...
        <v-card rounded="xl" elevation="0" class="section-card mb-4">
          <div
            class="section-header px-4 py-3 border-b d-flex align-center ga-2"
          >
            <v-icon icon="fas fa-certificate" color="gap-user" size="15" />
            <span class="text-subtitle-2 font-weight-bold"
          ...
          <v-table density="compact" class="pa-2">
            ...
            <tbody>
              <tr
                v-for="(std, i) in application.standards"
                :key="i"
              >
                <td class="text-body-2 text-medium-emphasis">{{ i + 1 }}</td>
                <td class="text-body-2">{{ std.scope }}</td>
                <td class="text-body-2 font-weight-medium text-gap-user">
                  {{ std.certNo }}
                </td>
              </tr>
            </tbody>
