<template>
  <div>
    ...
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-6">
      ...
      <v-btn color="primary" prepend-icon="fas fa-file-pen" @click="router.push('/gap/user/applications/new')">
        ยื่นคำขอใหม่
      </v-btn>
    </div>
        ...
        <v-card>
          <div class="d-flex align-center px-5 py-4 border-b">
            ...
            <v-btn variant="text" size="small" color="primary" append-icon="fas fa-arrow-right"
              @click="router.push('/gap/user/applications')">ดูทั้งหมด</v-btn>
          </div>
          <v-data-table
...
const quickActions = [
  { title: 'ยื่นคำขอใหม่',   desc: 'สร้างคำขอรับรอง GAP',       icon: 'fas fa-file-pen',      color: 'primary',   to: '/gap/user/applications/new' },
  { title: 'รายการคำขอ',     desc: 'ดูและจัดการคำขอทั้งหมด',    icon: 'fas fa-file-lines',    color: 'info',      to: '/gap/user/applications' },
  { title: 'ตั้งค่าระบบ',     desc: 'จัดการผู้ใช้และสิทธิ์',     icon: 'fas fa-gear',          color: 'secondary', to: '/gap/user/settings' },
]
</script>
