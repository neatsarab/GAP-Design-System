                    ...
                    <div class="d-flex align-center pa-6">
                        ...
                        <div class="d-flex align-center">
                            <div class="node-line-container">
                                ...
                                <v-btn icon variant="flat" color="gap-user" size="small" class="node-dot">
...
const appTypes = [
    {
        route: "/gap/user/applications/new/single/new",
        title: "แบบคำขอใบรับรองแหล่งผลิต GAP พืช (สำหรับรายเดี่ยว) F-1",
        description: "",
    ...
    },
    {
        ...
        title: "แบบคำขอใบรับรองแหล่งผลิต GAP พืช (สำหรับกลุ่ม) F-2",
        description: "",
    ...
    },
    {
        ...
        title: "แบบขอแก้ไขเปลี่ยนแปลงข้อมูลใบรับรอง F-5",
        icon: "fas fa-edit",
    ...
    },
    {
        ...
        title: "แบบคำขอยกเลิกการรับรอง F-6 (ฝั่งจนท. )",
