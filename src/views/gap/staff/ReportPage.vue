  ...
  <div>
    <div class="mb-5">
      ...
      <p class="text-body-2 text-medium-emphasis mb-0">
        สร้างและดาวน์โหลดรายงานการดำเนินงาน GAP
      </p>
    </div>
      ...
      <v-col v-for="rpt in reportTypes" :key="rpt.id" cols="12" sm="6" md="3">
        <v-card class="report-card h-100" @click="selectReport(rpt)">
          <v-card-text class="pa-5 d-flex flex-column align-center text-center">
            <div
              class="report-icon-box mb-3"
              :style="`background:rgba(var(--v-theme-${rpt.color}),0.12)`"
            >
    ...
    <v-card v-if="selectedReport">
      ...
      <v-card-actions class="px-5 pb-5 ga-3">
        ...
        <v-btn variant="tonal" color="grey" @click="clearSelectedReport"
          >ยกเลิก</v-btn
        >
      </v-card-actions>
    </v-card>
          ...
          <template v-for="(r, i) in recentReports" :key="r.id">
            <v-list-item>
              <template v-slot:prepend>
                <div
                  class="recent-icon mr-3"
                  :style="`background:rgba(var(--v-theme-${r.color}),0.1)`"
                >
              ...
              <v-list-item-subtitle class="text-caption"
                >{{ r.period }} · {{ r.format }}</v-list-item-subtitle
              >
...
const reportTypes = [
  {
    id: "applications",
    name: "รายงานคำขอ",
    desc: "สรุปจำนวนคำขอตามสถานะและช่วงเวลา",
  ...
  {
    id: "inspection",
    name: "รายงานการตรวจแปลง",
    desc: "ผลการตรวจประเมินแปลงและการวิเคราะห์ตัวอย่าง",
  ...
  },
  {
    id: "certificate",
    name: "รายงานใบรับรอง",
    desc: "รายการใบรับรองที่ออกแล้ว สถานะ หมดอายุ",
  ...
  {
    id: "statistics",
    name: "รายงานสถิติระบบ",
    desc: "ภาพรวมสถิติการใช้งานระบบและแนวโน้ม",
...
const recentReports = [
  {
    id: 1,
    name: "รายงานคำขอประจำเดือน ม.ค. 2569",
    period: "1–15 ม.ค. 68",
    format: "PDF",
    icon: "fas fa-file-pdf",
    color: "error",
    generatedAt: "15 ม.ค. 68 09:30",
  },
  {
    id: 2,
    name: "รายงานใบรับรองที่ออกในไตรมาส 1/2569",
    period: "ต.ค.–ธ.ค. 67",
    format: "Excel (.xlsx)",
    icon: "fas fa-file-excel",
    color: "success",
    generatedAt: "1 ม.ค. 68 10:00",
  },
  {
    id: 3,
    name: "รายงานการตรวจแปลงเดือน ธ.ค. 2569",
    period: "ธ.ค. 67",
    format: "PDF",
    icon: "fas fa-file-pdf",
    color: "error",
    generatedAt: "2 ม.ค. 68 14:20",
  },
];
</script>
