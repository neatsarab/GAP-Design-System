<template>
  <div style="--v-theme-primary: var(--v-theme-export-staff)">
    ...
    <v-row>
      <!-- ── Left: tabs ── -->
      <v-col cols="12" md="8">
        <v-tabs v-model="activeTab" color="export-staff" class="mb-4">
    ...
    <v-dialog v-model="factoryDialog" max-width="480">
      <v-card rounded="xl">
        <v-card-title class="d-flex align-center ga-2 pa-5 pb-3">
          <v-icon icon="fas fa-industry" color="export-staff" size="16" />
    ...
    <v-dialog v-model="gapDialog" max-width="480">
      <v-card rounded="xl">
        <v-card-title class="d-flex align-center ga-2 pa-5 pb-3">
          <v-icon icon="fas fa-seedling" color="export-staff" size="16" />
