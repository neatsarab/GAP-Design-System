    ...
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-6">
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          ภาพรวมระบบขึ้นทะเบียนโรงงานผลิตสินค้าพืช DOA
        </p>
      </div>
      <v-btn
        color="doa-user"
        prepend-icon="fas fa-file-pen"
        @click="router.push('/doa/user/applications/new')"
      >
        ยื่นคำขอใหม่
      </v-btn>
    </div>
        ...
        <v-card rounded="xl" elevation="0">
          ...
          <v-list lines="two" class="pa-0">
            <template v-for="(app, i) in recentApplications" :key="app.id">
              <v-list-item
                class="pa-3"
                @click="router.push(`/doa/user/applications/${app.id}`)"
              >
                <template #prepend>
                  <v-avatar
      ...
      <v-col cols="12" md="4">
        ...
        >
          ...
          <div class="text-body-2">
            คำขอ DOA-2568-00002 อยู่ระหว่างการตรวจสอบเอกสาร
          </div>
        </v-alert>
        <v-card rounded="xl" elevation="0">
          <v-card-title class="d-flex align-center ga-2 pa-4 pb-3">
...
const stats = [
  { label: "คำขอทั้งหมด", value: 4, icon: "fas fa-file-lines", iconColor: "doa-user" },
...
const recentApplications = [
  { id: "DOA-2568-00003", requestNo: "DOA-2568-00003", submittedDate: "5 มี.ค. 2568", status: "under_review" },
  { id: "DOA-2568-00002", requestNo: "DOA-2568-00002", submittedDate: "20 ก.พ. 2568", status: "inspection_scheduled" },
  { id: "DOA-2568-00001", requestNo: "DOA-2568-00001", submittedDate: "10 ม.ค. 2568", status: "approved" },
];

const quickActions = [
  { title: "ยื่นคำขอใหม่", icon: "fas fa-file-pen", color: "primary", to: "/doa/user/applications/new" },
