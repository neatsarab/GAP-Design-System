            ...
            <template v-if="currentStep === 0">
                ...
                <v-card rounded="xl" elevation="0" class="section-card mb-5">
                    <v-card-title class="pa-5 pb-3 section-title">
                        <v-icon icon="fas fa-triangle-exclamation" color="doa-user" class="mr-2" size="25" />
                        หมายเหตุจากเจ้าหน้าที่
                    </v-card-title>
                    <v-divider />
                    <v-card-text class="pa-5">
                        ...
                        <v-textarea v-model="form.remark" variant="outlined" density="compact" rounded="lg"
                            hide-details rows="3" placeholder="ระบุเหตุผล..." />
                    </v-card-text>
                </v-card>
                    ...
                    <v-card-text class="pa-5">
                        <v-row dense>
                            ...
                            <v-col cols="12" md="3">
                                ...
                                <v-text-field v-model="form.applicantAge" variant="outlined" density="compact"
                                    rounded="lg" hide-details />
                            </v-col>
                            <v-col cols="12" md="3">
                                <div class="field-label">
                            ...
                            <v-col cols="12" md="3">
                                ...
                                <v-text-field v-model="form.applicantMoo" variant="outlined" density="compact"
                                    rounded="lg" hide-details maxlength="13" />
                            </v-col>
                            <v-col cols="12" md="3">
                                <div class="field-label">
                                ...
                                <v-text-field v-model="form.applicantSoi" variant="outlined" density="compact"
                                    rounded="lg" hide-details />
                            </v-col>
                            <v-col cols="12" md="3">
                                <div class="field-label">
                                ...
                                <v-text-field v-model="form.applicantRoad" variant="outlined" density="compact"
                                    rounded="lg" hide-details />
                            </v-col>
                            <v-col cols="12" md="3">
                                <div class="field-label">
                            ...
                            <v-col cols="12" md="3">
                                ...
                                <v-select v-model="form.applicantDistrict" variant="outlined" density="compact"
                                    rounded="lg" hide-details maxlength="13" />
                            </v-col>
                            <v-col cols="12" md="3">
                                <div class="field-label">
                                ...
                                <v-select v-model="form.applicantProvince" variant="outlined" density="compact"
                                    rounded="lg" hide-details maxlength="13" />
                            </v-col>
                            <v-col cols="12" md="3">
                                <div class="field-label">
                    ...
                    <v-card-text class="pa-5">
                        <v-row dense>
                            ...
                            <v-col cols="12" md="6">
                                ...
                                <v-text-field v-model="form.factoryNameTh" variant="outlined" density="compact"
                                    rounded="lg" hide-details />
                            </v-col>
                            <v-col cols="12" md="6">
                                <div class="field-label">
                ...
                <v-card rounded="xl" elevation="0" class="section-card mb-5">
                    <v-card-title class="pa-5 pb-3 d-flex align-center justify-space-between section-title">
                        ...
                        <v-btn color="doa-user" variant="tonal" size="small" rounded="lg" prepend-icon="fas fa-plus"
                        ...
                        <v-row dense>
                            <v-col v-for="doc in docFileDoa" :key="doc.key" cols="12">
                                <div
                                    ...
                                    <div class="d-flex align-center ga-2">
                                        <v-chip v-if="uploadedFiles[doc.key]" color="success" size="x-small"
                                            variant="tonal" prepend-icon="fas fa-check">
                                            {{ uploadedFiles[doc.key] }}
                                        </v-chip>
                                        <v-btn :color="uploadedFiles[doc.key] ? 'success' : 'doa-user'" variant="tonal"
                                            size="small" rounded="lg" prepend-icon="fas fa-upload"
                    ...
                    <v-card-text class="pa-5">
                        <v-row dense>
                            <v-col cols="12" md="4">
                                ...
                                <v-autocomplete v-model="standardForm.standard" :items="standardOptions"
