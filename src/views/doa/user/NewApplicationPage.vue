<template>
    <div style="--v-theme-primary: var(--v-theme-doa-user)">
                ...
                <v-card-text class="pa-5">
                    <v-row dense>
                        ...
                        <v-col cols="12" md="3">
                            ...
                            <v-select v-model="form.applicantSubDistrict" variant="outlined" density="compact"
                                rounded="lg" hide-details maxlength="13" />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-select v-model="form.applicantDistrict" variant="outlined" density="compact" rounded="lg"
                                hide-details maxlength="13" />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-select v-model="form.applicantProvince" variant="outlined" density="compact" rounded="lg"
                                hide-details maxlength="13" />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
        ...
        <!-- Standard Dialog -->
        <v-dialog v-model="standardDialog" max-width="1000">
            <v-card rounded="xl">
                <v-card-title class="pa-5 pb-3 text-body-1 font-weight-bold">
                    <v-icon icon="fas fa-certificate" color="doa-user" class="mr-2" size="18" />
                    {{ standardDialogIndex === -1 ? "ขอบข่ายมาตรฐานที่ขอขึ้นทะเบียน" :
                        "แก้ไขขอบข่ายมาตรฐานที่ขอขึ้นทะเบียน " }}
                </v-card-title>
                <v-divider />
                <v-card-text class="pa-5">
                    <v-row dense>
                        ...
                        <v-col cols="12" md="4">
                            <div class="field-label">
                                <div>
                                    ชื่อหน่วยรับรองโรงงาน <span class="req">*</span>
                                </div>
                            </div>
                ...
                <v-card-actions class="px-5 pb-5 ga-2">
                    <v-btn variant="tonal" color="doa-user" rounded="lg" @click="closeStandardDialog">ยกเลิก</v-btn>
                    <v-btn variant="flat" color="doa-user" rounded="lg" @click="saveStandard">บันทึก</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
        ...
        <v-dialog v-model="confirmDialog" max-width="420">
            <v-card rounded="xl">
                ...
                <v-card-actions class="px-6 pb-5 ga-2">
                    <v-btn variant="tonal" color="grey" rounded="lg" block @click="closeConfirmDialog">ยกเลิก</v-btn>
