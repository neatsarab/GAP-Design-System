<template>
    <div style="--v-theme-primary: var(--v-theme-doa-user)">
        ...
        <template v-if="currentStep === 0">
            ...
            <v-card rounded="xl" elevation="0" class="section-card mb-5">
                <v-card-title class="pa-5 pb-3 section-title">
                    <v-icon icon="fas fa-file-pen" color="doa-user" class="mr-2" size="25" />
                ...
                <v-card-text class="pa-5">
                    ...
                    <template v-if="isRegister">
                        <v-radio-group v-model="form.purpose" color="doa-user">
                            ...
                            <v-radio value="renew" label="ต่ออายุการขึ้นทะเบียนโรงงานผลิตสินค้าพืช" />
                        </v-radio-group>
                        ...
                        <v-expand-transition>
                            <div v-if="form.purpose === 'renew'" class="ml-10 mt-n5">
                                <v-row dense align="center">
                                    <v-col cols="12" md="4">
                                        <v-text-field v-model="form.registrationNumber" placeholder="กรอกเลขทะเบียนเดิม"
                                            variant="outlined" density="comfortable" rounded="lg" hide-details />
                                    </v-col>
                                    <v-col cols="12" md="2">
                                        <v-btn color="doa-user" block height="48" rounded="lg" elevation="0"
                    ...
                    <template v-else>
                        <v-row dense align="center">
                            <v-col cols="12" md="4">
                                <div class="field-label mb-1">เลขทะเบียนโรงงาน <span class="req">*</span></div>
                                <v-text-field v-model="form.registrationNumber"
                                    placeholder="กรอกเลขทะเบียนที่ต้องการแก้ไข" variant="outlined" density="comfortable"
                ...
                <v-card-text class="pa-5">
                    ...
                    <v-row dense>
                        <v-col cols="12" md="3">
                            ...
                            <v-text-field v-model="form.applicantNameTh" variant="outlined" density="compact"
                                rounded="lg" hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.applicantIdCard" variant="outlined" density="compact"
                        ...
                        <v-col cols="12" md="3">
                            ...
                            <v-text-field v-model="form.applicantAge" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-autocomplete v-model="form.applicantNationality" variant="outlined" density="compact"
                                rounded="lg" hide-details maxlength="13" :items="['ไทย']"/>
                        </v-col>
                    </v-row>
                    <!-- ที่อยู่ -->
                    ...
                    <v-row dense>
                        <v-col cols="12" md="3">
                            ...
                            <v-text-field v-model="form.applicantAddressNo" variant="outlined" density="compact"
                                rounded="lg" hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.applicantMoo" variant="outlined" density="compact" rounded="lg"
                        ...
                        <v-col cols="12" md="3">
                            ...
                            <v-text-field v-model="form.applicantSoi" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.applicantRoad" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-autocomplete v-model="form.applicantSubDistrict" variant="outlined" density="compact"
                                rounded="lg" hide-details maxlength="13" :items="['บางพลัด']"/>
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                                <div>อำเภอ/เขต<span class="req">*</span></div>
                            </div>
                            <v-autocomplete v-model="form.applicantDistrict" variant="outlined" density="compact" rounded="lg"
                                hide-details maxlength="13" :items="['บางพลัด']"/>
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                                <div>จังหวัด<span class="req">*</span></div>
                            </div>
                            <v-autocomplete v-model="form.applicantProvince" variant="outlined" density="compact" rounded="lg"
                                hide-details maxlength="13" :items="['กรุงเทพมหานคร']" />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                    ...
                    <v-row dense>
                        ...
                        <v-col cols="12" md="4">
                            ...
                            <v-text-field v-model="form.applicantFax" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="4">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.applicantEmail" type="email" variant="outlined"
            ...
            <v-card rounded="xl" elevation="0" class="section-card mb-5">
                <v-card-title class="pa-5 pb-3 section-title">
                    <v-icon icon="fas fa-industry" color="doa-user" class="mr-2" size="18" />
                    ข้อมูลโรงงานผลิตสินค้าพืช
                </v-card-title>
                <v-divider />
                <v-card-text class="pa-5">
                    ...
                    <v-row dense>
                        <v-col cols="12" class="mt-4 d-flex">
                            ...
                            <v-radio-group v-model="form.factoryType" color="doa-user" inline class="mt-n3">
                    ...
                    <v-row dense>
                        <v-col cols="12" md="6">
                            ...
                            <v-text-field v-model="form.factoryNameTh" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="6">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.factoryNameEn" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                    </v-row>
                    ...
                    <v-row dense>
                        <v-col cols="12" md="3">
                            ...
                            <v-text-field v-model="form.factoryAddressNo" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.factoryMoo" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                        ...
                        <v-col cols="12" md="3">
                            ...
                            <v-text-field v-model="form.factoryzone" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.factorySoi" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.factoryRoad" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="3">
                            <div class="field-label">
                    ...
                    <v-row dense>
                        <v-col cols="12" md="6">
                            ...
                            <v-text-field v-model="form.factoryPhone" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="6">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.factoryFax" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                    </v-row>
                    ...
                    <v-row dense>
                        <v-col cols="12" md="6">
                            ...
                            <v-text-field v-model="form.factoryLat" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12" md="6">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="form.factoryLng" variant="outlined" density="compact" rounded="lg"
                                hide-details />
                        </v-col>
                        <v-col cols="12">
                            <div id="leaflet-map"
            ...
            <v-card rounded="xl" elevation="0" class="section-card mb-5">
                <v-card-title class="pa-5 pb-3 d-flex align-center justify-space-between section-title">
                    <span>
                        <v-icon icon="fas fa-certificate" color="doa-user" class="mr-2" size="18" />
                        ขอบข่ายมาตรฐานที่ขอขึ้นทะเบียน
                    </span>
                    <v-btn v-if="isRegister" color="doa-user" variant="tonal" size="small" rounded="lg"
                        prepend-icon="fas fa-plus" @click="openStandardDialog()">
                        เพิ่มขอบข่าย
                    </v-btn>
                </v-card-title>
                <v-divider />
                <v-table density="comfortable" class="pa-2">
                    ...
                    <tbody>
                        <tr v-if="form.standards.length === 0">
                            <td colspan="6" class="text-center text-medium-emphasis py-5 text-body-2">
                        ...
                        <tr v-for="(std, idx) in form.standards" :key="idx">
                            ...
                            <td class="text-right">
                                <v-btn icon="fas fa-pen" variant="text" size="x-small" color="doa-user"
                                    @click="openStandardDialog(idx)" v-if="!isScope"/>
                                <v-btn icon="fas fa-trash" variant="text" size="x-small" color="error"
                                    @click="removeStandard(idx)" v-if="!isScope"/>
                            </td>
                        </tr>
                    </tbody>
                </v-table>
            ...
            <v-card v-if="isAmendment" rounded="xl" elevation="0" class="section-card mb-5">
                <v-card-title class="pa-5 pb-3 section-title">
                    <v-icon icon="fas fa-file-pen" color="doa-user" class="mr-2" size="25" />
                    ข้อมูลที่ต้องการแก้ไข
                </v-card-title>
                ...
                <v-card-text class="pa-5">
                    <v-row dense>
                        <v-col v-for="main in objectives" :key="main.value" cols="12" class="mb-2">
                            <!-- หัวข้อหลัก-->
                            <v-checkbox v-model="form.objectives" :value="main.value" :label="main.label"
                                color="doa-user" density="compact" hide-details
                            ...
                            <div class="ml-9 mt-1">
                                ...
                                <div v-for="sub in main.children" :key="sub.value" class="mb-2">
                                    <v-checkbox v-model="form.objectives" :value="sub.value" :label="sub.label"
                                        color="doa-user" density="compact" hide-details
                                        @update:model-value="syncParentStatus(main, sub)" />

                                    <!-- ช่อง Input ของหัวข้อย่อย -->
                                    <v-text-field v-if="sub.hasInput && form.objectives.includes(sub.value)"
                                        v-model="form.objectiveDetails[sub.value]" placeholder="ระบุรายละเอียด"
                                        variant="outlined" density="compact" rounded="lg" class="mt-2" hide-details />
                                </div>

                                <!-- ช่อง Input กรณีหัวข้อหลักเองต้องมีช่องกรอก (ข้อ 4 อื่นๆ) -->
                                <v-text-field
                                    v-if="main.hasInput && !main.children.length && form.objectives.includes(main.value)"
                                    v-model="form.objectiveDetails[main.value]" placeholder="ระบุรายละเอียด"
                                    variant="outlined" density="compact" rounded="lg" class="mt-2" hide-details />
                            </div>
                        </v-col>
                    </v-row>
            ...
            <v-card v-if="isScope" rounded="xl" elevation="0" class="section-card mb-5">
                <v-card-title class="pa-5 pb-3 section-title">
                ...
                <v-card-text class="pa-5">
                    <v-row dense>
                        ...
                        <v-col cols="12" class="mb-4">
                            <v-checkbox v-model="form.scopeOptions" value="standard" color="doa-user" density="compact"
                                hide-details
                            ...
                            <v-expand-transition>
                                <div v-if="form.scopeOptions.includes('standard')" class="ml-9 mt-4">
                                    <v-sheet border rounded>
                                        <div class="d-flex align-center justify-space-between pa-4 ">
                                            <div
                                                class="text-subtitle-1 font-weight-bold text-doa-user d-flex align-center">

                                                <v-icon icon="fas fa-certificate" color="doa-user" class="mr-3"
                                                    size="22"
                                                    style="filter: drop-shadow(0px 0px 2px rgba(var(--v-theme-doa-user), 0.4))" />
                                                ขอบข่ายมาตรฐานที่ขอขึ้นทะเบียน
                                            </div>
                                            <v-btn color="doa-user" variant="tonal" size="small" rounded="lg"
                                                prepend-icon="fas fa-plus" @click="openStandardDialog()">
                                                เพิ่มขอบข่าย
                                            </v-btn>
                                        </div>
                                        ...
                                        <v-table density="comfortable" class="standards-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-subtitle-2 font-weight-bold">ขอบข่ายมาตรฐาน</th>
                                                    <th class="text-subtitle-2 font-weight-bold">
                                                        หน่วยรับรองที่ให้การรับรองมาตรฐาน
                                                    </th>
                                                    <th class="text-subtitle-2 font-weight-bold">เลขที่ใบรับรอง</th>
                                                    <th class="text-subtitle-2 font-weight-bold">
                                                        วันที่ได้รับการรับรอง
                                                    </th>
                                                    <th class="text-subtitle-2 font-weight-bold">วันหมดอายุ</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr v-for="(std, idx) in form.standards" :key="idx">
                                                    ...
                                                    <td class="text-right pa-2">
                                                        <v-btn icon="fas fa-pen" variant="text" size="x-small"
                                                            color="doa-user" @click="openStandardDialog(idx)" />
                                                        <v-btn icon="fas fa-trash" variant="text" size="x-small"
                                                            color="error" @click="removeStandard(idx)" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </v-table>
                        ...
                        <v-col cols="12">
                            <v-checkbox v-model="form.scopeOptions" value="product" color="doa-user" density="compact"
                                hide-details label="2. เพิ่ม / ลดขอบข่ายผลิตภัณฑ์" />
                        </v-col>
                    </v-row>
                </v-card-text>
            </v-card>
        ...
        <div class="d-flex justify-space-between align-center mt-6">
            ...
            <div class="d-flex ga-2">
                <v-btn variant="tonal" color="doa-user" prepend-icon="fas fa-floppy-disk" @click="saveDraft">
                    บันทึกแบบร่าง
                </v-btn>
                <v-btn v-if="currentStep < steps.length - 1" color="doa-user" append-icon="fas fa-arrow-right"
                    @click="nextStep">
                    ถัดไป
                </v-btn>
                <v-btn v-else color="doa-user" prepend-icon="fas fa-paper-plane" @click="openConfirmDialog">
                    ยื่นคำขอ
                </v-btn>
            </div>
        </div>
                ...
                <v-card-text class="pa-5">
                    <v-row dense>
                        <v-col cols="12">
                            ...
                            <v-autocomplete v-model="standardForm.standard" :items="standardOptions" variant="outlined"
                                density="compact" rounded="lg" hide-details />
                        </v-col>
                        <v-col cols="12">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="standardForm.certBody" variant="outlined" density="compact"
                                rounded="lg" hide-details />
                        </v-col>
                        <v-col cols="12">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="standardForm.certNo" variant="outlined" density="compact"
                                rounded="lg" hide-details />
                        </v-col>
                        <v-col cols="12" md="6">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="standardForm.issueDate" type="date" variant="outlined"
                                density="compact" rounded="lg" hide-details />
                        </v-col>
                        <v-col cols="12" md="6">
                            <div class="field-label">
                            ...
                            <v-text-field v-model="standardForm.expireDate" type="date" variant="outlined"
                                density="compact" rounded="lg" hide-details />
                        </v-col>
                    </v-row>
                </v-card-text>
                <v-card-actions class="px-5 pb-5 ga-2">
                    <v-btn variant="tonal" color="grey" rounded="lg" @click="closeStandardDialog">ยกเลิก</v-btn>
                    <v-spacer />
                    <v-btn color="doa-user" rounded="lg" @click="saveStandard">บันทึก</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
            ...
            <v-card rounded="xl">
                ...
                <v-card-actions class="px-6 pb-5">
                    <v-row no-gutters class="ga-2 w-100">
                        <v-col>
                            <v-btn variant="tonal" color="grey" rounded="lg" block
                                @click="closeConfirmDialog">ยกเลิก</v-btn>
                        </v-col>
                        <v-col>
                            <v-btn color="doa-user" rounded="lg" block @click="submitApplication">ยืนยัน</v-btn>
                        </v-col>
                    </v-row>
                </v-card-actions>
            </v-card>
        ...
        <v-dialog v-model="successDialog" max-width="420" persistent>
            <v-card rounded="xl">
                ...
                <v-card-actions class="px-6 pb-5">
                    <v-btn color="doa-user" rounded="lg" block @click="goToApplicationList">
                        ดูรายการคำขอ
                    </v-btn>
                </v-card-actions>
            </v-card>
...
const objectives = [
    {
        ...
        children: [
            { value: "change_cb", label: "เปลี่ยนแปลงหน่วยรับรองโรงงานผลิตสินค้าพืช (CB)", hasInput: true },
    ...
    },
    {
        ...
        children: [
            { value: "juristic_name", label: "เปลี่ยนแปลงจากชื่อนิติบุคคลเป็นนิติบุคคล (ทะเบียนนิติบุคคลเลขที่เดิม)" },
            { value: "person_name_gov", label: "เปลี่ยนแปลงจากชื่อบุคคลธรรมดาเป็นชื่อบุคคลธรรมดา (มีการเปลี่ยนแปลงจากกรมการปกครอง)" },
            { value: "person_name_com", label: "เปลี่ยนแปลงจากชื่อบุคคลธรรมดาเป็นชื่อบุคคลธรรมดา (มีการเปลี่ยนแปลงการจดทะเบียนพาณิชย์)" }
        ]
    },
    {
        value: "cert_expire",
        ...
        children: [
            { value: "notify_renew", label: "แจ้งรายละเอียดการต่ออายุใบรับรองมาตรฐานสินค้าเกษตร" }
        ]
    },
    {
        value: "other",
...
const docFileDoa = [
    { key: "cert_copy", label: "1. สำเนาใบรับรองมาตรฐานจากกรมวิชาการเกษตรหรือหน่วยรับรองโรงงานผลิตสินค้าพืช" },
    { key: "scope_copy", label: "2. สำเนารายละเอียดขอบข่ายผลิตภัณฑ์ที่ได้รับการรับรองมาตรฐานจากหน่วยรับรอง (กรณีไม่ได้มีการระบุขอบข่ายผลิตภัณฑ์ไว้ในเอกสารข้อ ...)" },
    { key: "map_copy", label: "3. แผนภูมิกระบวนการผลิต" },
    { key: "haccp_plan", label: "4. แผน HACCP PLAN (กรณีขอขึ้นทะเบียน มกษ. 9024-2550 ) " },
];
