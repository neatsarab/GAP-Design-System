                ...
                <v-row dense align="center">
                    ...
                    <v-col cols="12" sm="6" md="3">
                        ...
                        <v-menu v-model="dateToMenu" :close-on-content-click="false" location="bottom start">
                            <template #activator="{ props }">
                                <v-text-field v-bind="props" density="compact" :model-value="dateToBE" readonly
                                    clearable prepend-inner-icon="fas fa-calendar"
                                    placeholder="เลือกวันที่ / เดือน / ปี" hide-details style="cursor: pointer"
                ...
                <template #item.actions="{ item }">
                    <div class="d-flex align-center ga-1">
                        <v-tooltip text="ดูคำขอ" location="top">
                            <template #activator="{ props }">
                                <v-btn v-bind="props" icon size="x-small" variant="text" color="doa-staff" @click.stop="
                                    router.push({
                        ...
                        <v-btn v-if="['reviewing'].includes(item.status)" size="small" variant="tonal" color="warning"
                            rounded="lg" prepend-icon="fas fa-clipboard-check" @click.stop="
                                router.push({
                                    name: 'DOAStaffReviewDetail',
                                    params: { id: item.requestNo },
                                })
