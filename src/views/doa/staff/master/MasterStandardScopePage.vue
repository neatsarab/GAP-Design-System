    ...
    <div class="d-flex align-center justify-space-between mb-6">
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          จัดการรายการขอบข่ายมาตรฐานที่ใช้ในระบบ
        </p>
      </div>
      <v-btn
        color="doa-staff"
      ...
      <v-card rounded="xl">
        ...
        <v-card-actions class="pa-5 ga-2">
          ...
          <v-btn
            ...
            rounded="lg"
            @click="saveForm"
            >{{ editingItem ? "บันทึกการแก้ไข" : "เพิ่มมาตรฐาน" }}</v-btn
          >
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="deleteDialog" max-width="380">
      <v-card rounded="xl">
        <v-card-text class="pa-7 text-center">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            ต้องการลบ
            <strong>{{ deletingItem?.code }}</strong>
...
const items = ref([
  {
    id: 1,
    code: "มกษ. 9023-2550",
    nameTh: "การปฏิบัติที่ดีสำหรับโรงคัดบรรจุผักและผลไม้สด",
    nameEn:
      "Good Manufacturing Practice for Fresh Fruit and Vegetable Packing Houses",
    category: "GMP",
    description: "",
    status: "active",
  },
  {
    id: 2,
    code: "มกษ. 9041-2556",
    nameTh: "การปฏิบัติที่ดีสำหรับโรงงานผลิตสินค้าเกษตรอินทรีย์",
    nameEn: "Good Manufacturing Practice for Organic Agricultural Products",
    category: "GMP",
    description: "",
    status: "active",
  },
  {
    id: 3,
    code: "มกษ. 4402-2552",
    nameTh: "การปฏิบัติทางการเกษตรที่ดีสำหรับข้าว",
    nameEn: "Good Agricultural Practice for Rice",
    category: "GAP",
    description: "",
    status: "active",
  },
  {
    ...
    code: "มกษ. 9001-2556",
    nameTh:
      "เกษตรอินทรีย์ เล่ม 1 การผลิต แปรรูป แสดงฉลาก และจำหน่ายผลิตผลและผลิตภัณฑ์เกษตรอินทรีย์",
    nameEn: "Organic Agriculture Part 1",
    category: "GAP",
    description: "",
    status: "inactive",
  },
