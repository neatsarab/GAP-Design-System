    ...
    <v-dialog v-model="formDialog" max-width="520" persistent>
      <v-card rounded="xl">
        ...
        <v-card-actions class="pa-5 ga-2">
          ...
          <v-btn color="doa-staff" rounded="lg" @click="saveForm">{{ editingItem ? 'บันทึกการแก้ไข' : 'เพิ่มผลิตภัณฑ์' }}</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
      ...
      <v-card rounded="xl">
        <v-card-text class="pa-7 text-center">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            ต้องการลบ <strong>{{ deletingItem?.nameTh }}</strong> ใช่หรือไม่?<br>การกระทำนี้ไม่สามารถย้อนกลับได้
          </p>
        </v-card-text>
