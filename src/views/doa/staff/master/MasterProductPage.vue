                ...
                <v-row dense align="center">
                    <v-col cols="12" sm="5" md="4">
                        ...
                        <v-text-field v-model="search" variant="outlined" density="compact" rounded="lg" hide-details
                            placeholder="ค้นหารหัส / ชื่อผลิตภัณฑ์..." prepend-inner-icon="fas fa-magnifying-glass"
                            clearable />
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
                        ...
                        <v-autocomplete v-model="filterType" :items="typeOptions" item-title="label" item-value="value"
                            placeholder="ประเภทสินค้าทั้งหมด" variant="outlined" density="compact" rounded="lg"
        ...
        <v-card rounded="xl" elevation="0" class="data-card">
            <v-data-table :headers="headers" :items="filteredItems" :search="search" rounded="xl" hover>
                ...
                <template #item.type="{ item }">
                    <v-chip size="small" variant="tonal" color="doa-staff">{{ typeLabel(item.type) }}</v-chip>
                </template>
                    ...
                    <v-row dense>
                        <v-col cols="12" sm="4">
                            ...
                            <v-text-field v-model="form.code" variant="outlined" density="compact" rounded="lg"
                                hide-details placeholder="เช่น PRD-001" />
                        </v-col>
                        <v-col cols="12" sm="8">
                            <div class="field-label">
                            ...
                            <v-autocomplete v-model="form.type" :items="typeOptions" item-title="label"
                        ...
                        <v-col cols="12">
                            ...
                            <v-text-field v-model="form.unit" variant="outlined" density="compact" rounded="lg"
                                hide-details placeholder="เช่น กก., ตัน, ลิตร" />
                        </v-col>
                        <v-col cols="12">
                            <div class="field-label mt-2">
                                <div>สถานะ</div>
            ...
            <v-card rounded="xl">
                <v-card-text class="pa-7 text-center">
                    ...
                    <p class="text-body-2 text-medium-emphasis mb-0">
                        ต้องการลบ <strong>{{ deletingItem?.nameTh }}</strong>
...
const items = ref([
    ...
    { id: 4, code: "PRD-004", nameTh: "ข้าวหอมมะลิ", nameEn: "Jasmine Rice", type: "grain", unit: "ตัน", status: "active" },
    { id: 5, code: "PRD-005", nameTh: "กระเจี๊ยบแดง", nameEn: "Roselle", type: "herb", unit: "กก.", status: "inactive" },
]);
...
function openAdd() {
    ...
    form.code = ""; form.nameTh = ""; form.nameEn = ""; form.type = ""; form.unit = ""; form.isActive = true;
...
function saveForm() {
    if (editingItem.value) {
        ...
        items.value.push({ id: nextId++, code: form.code, nameTh: form.nameTh, nameEn: form.nameEn, type: form.type, unit: form.unit, status: form.isActive ? "active" : "inactive" });
    }
    formDialog.value = false;
}
