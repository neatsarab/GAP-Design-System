    ...
    <div class="d-flex align-center justify-space-between mb-5 flex-wrap ga-3">
      <div>
        ...
        <p class="text-body-2 text-medium-emphasis mb-0">
          รายการทะเบียนโรงงานผลิตสินค้าพืชที่ได้รับการขึ้นทะเบียนแล้ว
        </p>
      </div>
      <v-btn variant="tonal" color="doa-staff" prepend-icon="fas fa-download"
        >ส่งออก Excel</v-btn
      >
    </div>
    ...
    <v-card rounded="xl" elevation="0" class="mb-4 filter-card">
      <v-card-text class="pa-4">
        <v-row dense align="center">
          ...
          <v-col cols="6" sm="3">
            <div class="field-label">
              <div>ประเภทสถานประกอบการ</div>
              <div class="field-label-en">Type</div>
            </div>
            <v-autocomplete
              v-model="filterType"
              :items="factoryTypeOptions"
              placeholder="ทั้งหมด"
              variant="outlined"
              density="compact"
              rounded="lg"
        ...
        <v-card-text v-if="selected" class="pa-5">
          <v-row dense>
            <v-col cols="6"
              ...
              <div class="info-value">{{ selected.factoryType }}</div></v-col
            >
            <v-col cols="12"
            ...
            <v-col cols="12"
              ...
              <div class="info-value">{{ selected.address }}</div></v-col
            >
            <v-col cols="6"
...
const allItems = [
  {
    id: "r1",
    factoryName: "บ.สยามฟู้ด จก.",
    factoryType: "โรงงานแปรรูป",
    address: "88/1 ต.บางปะกง อ.บางปะกง จ.ฉะเชิงเทรา",
    standards: ["มกษ. 9023-2550", "มกษ. 9024-2550"],
  ...
  {
    id: "r2",
    factoryName: "บ.ไทยโปรเซส จก.",
    factoryType: "โรงคัดบรรจุ",
    address: "200 ถ.มิตรภาพ อ.เมือง จ.นครราชสีมา",
    standards: ["มกษ. 9023-2550"],
  ...
  {
    id: "r3",
    factoryName: "บ.กรีนฟู้ด จก.",
    factoryType: "โรงงานแปรรูป",
    address: "55 ม.4 ต.สระแก้ว อ.เมือง จ.สระแก้ว",
    standards: ["ISO 22000"],
  ...
  {
    id: "r4",
    factoryName: "บ.อีสานฟู้ดส์ จก.",
    factoryType: "โรงคัดบรรจุ",
    address: "12 ม.3 ต.ในเมือง อ.เมือง จ.ขอนแก่น",
    standards: ["มกษ. 9023-2550"],
    issueDate: "10/06/2566",
    expireDate: "10/06/2569",
    status: "active",
  },
  {
    id: "r5",
    factoryName: "บ.นอร์ทเทิร์น จก.",
    factoryType: "โรงงานแปรรูป",
    address: "9/1 ถ.เชียงใหม่-ลำพูน ต.หนองหอย จ.เชียงใหม่",
    standards: ["มกษ. 9024-2550"],
    issueDate: "20/09/2565",
    expireDate: "20/09/2569",
    status: "expiring",
  },
];
...
const filteredItems = computed(() => {
  ...
  if (filterType.value)
    items = items.filter((i) => i.factoryType === filterType.value);
  return items;
});
