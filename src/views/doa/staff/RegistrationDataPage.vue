            ...
            <v-card-text class="pa-4">
                <v-row dense align="center">
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <v-text-field v-model="searchRequest"
                    ...
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <v-autocomplete v-model="filterTypecert" :items="typecertOptions" item-title="label"
                    ...
                    <v-col cols="12" sm="6" md="3">
                        ...
                        <v-menu v-model="expireFromMenu" :close-on-content-click="false" location="bottom start">
                            ...
                            <v-date-picker v-model="expireFromObj" color="doa-staff" show-adjacent-months
                    ...
                    <v-col cols="12" sm="6" md="3">
                        ...
                        <v-menu v-model="expireToMenu" :close-on-content-click="false" location="bottom start">
                            ...
                            <v-date-picker v-model="expireToObj" color="doa-staff" show-adjacent-months
                ...
                <template #item.actions="{ item }">
                    <div class="d-flex align-center ga-1">
                        <v-tooltip text="ดูรายละเอียด" location="top">
                            <template #activator="{ props }">
                                <v-btn v-bind="props" icon size="x-small" variant="text" color="doa-staff" @click.stop="goToRegistrationDetail(item)">
                        ...
                        <v-tooltip text="ดาวน์โหลด" location="top">
                            <template #activator="{ props }">
                                <v-btn v-bind="props" icon size="x-small" variant="text" color="success"
                                    :disabled="item.status === 'expired'" @click.stop>
                                    <v-icon icon="fas fa-download" size="14" />
                                </v-btn>
                            </template>
                        </v-tooltip>
                        <v-btn size="small" variant="tonal" color="doa-staff" rounded="lg"
                            prepend-icon="fas fa-file-pen" :disabled="item.status === 'expired'" @click.stop="goToRegistrationManage(item)">
                            จัดการใบรับรอง
                        </v-btn>
                    </div>
                </template>
...
function goToRegistrationDetail(item) {
    router.push({
        name: "DOAStaffRegistrationDetail",
        params: { id: item.certNo },
    });
}
function goToRegistrationManage(item) {
    router.push({
