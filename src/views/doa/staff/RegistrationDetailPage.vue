                        ...
                        <v-row dense>
                            ...
                            <v-col cols="12" md="4">
                                ...
                                <div class="info-value">
                                    <v-chip :color="certStatusColor(cert.status)" size="small" variant="tonal"
                            ...
                            <v-col cols="12" md="4">
                                ...
                                <div class="info-value" :class="cert.status === 'expiring'
                    ...
                    <v-card rounded="xl" elevation="0" class="section-card">
                        ...
                        <v-card-text class="pa-4">
                            <div class="activity-timeline">
                                <div v-for="(event, i) in cert.activityLog" :key="i" class="activity-item">
