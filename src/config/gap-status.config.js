...
export const GAP_STATUS_MAP = {
  ...
  SUBMITTED: {
    ...
    labelEn: "Submitted",
    descriptionTh:
      "คำขอถูกส่งถึงกรมวิชาการเกษตรแล้ว อยู่ระหว่างรอการตรวจสอบเอกสาร",
    semantic: "info",
    color: "info",
  ...
  DOC_REVIEW: {
    ...
    descriptionTh:
      "เจ้าหน้าที่กำลังตรวจสอบความถูกต้องและครบถ้วนของเอกสารประกอบคำขอ",
    semantic: "warning",
    color: "warning",
  ...
  INSPECTION_SCHEDULED: {
    ...
    descriptionTh:
      "เอกสารผ่านการตรวจสอบ นัดหมายผู้ตรวจประเมินลงพื้นที่แปลงเรียบร้อยแล้ว",
    semantic: "warning",
    color: "warning",
  ...
  INSPECTING: {
    ...
    labelEn: "Inspecting",
    descriptionTh:
      "ผู้ตรวจประเมินกำลังดำเนินการตรวจประเมินแปลงผลิตตามมาตรฐาน GAP",
    semantic: "info",
    color: "info",
  ...
  APPROVED: {
    ...
    labelEn: "Approved",
    descriptionTh:
      "แปลงผลิตผ่านการตรวจประเมินตามมาตรฐาน GAP แล้ว อยู่ระหว่างดำเนินการออกใบรับรอง",
    semantic: "success",
    color: "success",
  ...
  CERT_EXPIRED: {
    ...
    descriptionTh:
      "ใบรับรอง GAP ครบกำหนดอายุแล้ว เกษตรกรต้องยื่นคำขอต่ออายุใหม่",
    semantic: "muted",
    color: "default",
  ...
  REJECTED: {
    ...
    labelEn: "Rejected",
    descriptionTh:
      "คำขอถูกปฏิเสธโดยเจ้าหน้าที่ เนื่องจากเอกสารไม่ครบ / ไม่ผ่านมาตรฐาน GAP",
    semantic: "error",
    color: "error",
...
export const TRANSITION_RULES = [
  ...
  // ── DRAFT → CANCELLED ──────────────────────────────────────────────────────
  {
    ...
    to: "CANCELLED",
    by: ["FARMER", "ADMIN"],
    conditions: ["เกษตรกรหรือ Admin ยืนยันการยกเลิก"],
  ...
  // ── SUBMITTED → CANCELLED ──────────────────────────────────────────────────
  {
    ...
    conditions: ["ยืนยันการยกเลิก", "บันทึกเหตุผลการยกเลิก"],
  },
  ...
  // ── DOC_REVIEW → CANCELLED ─────────────────────────────────────────────────
  {
    ...
    to: "CANCELLED",
    by: ["staff", "SUPERVISOR", "ADMIN"],
    conditions: ["ยืนยันการยกเลิก", "บันทึกเหตุผล"],
  },
  ...
  // ── INSPECTION_SCHEDULED → REJECTED ───────────────────────────────────────
  {
    ...
    to: "REJECTED",
    by: ["staff", "SUPERVISOR", "ADMIN"],
    conditions: ["เกษตรกรไม่มาตามนัดโดยไม่แจ้ง (เกิน 2 ครั้ง)", "บันทึกเหตุผล"],
  },
  ...
  // ── INSPECTION_SCHEDULED → CANCELLED ──────────────────────────────────────
  {
    ...
    to: "CANCELLED",
    by: ["FARMER", "staff", "ADMIN"],
    conditions: ["ยืนยันการยกเลิก", "บันทึกเหตุผลและวันที่"],
  ...
  // ── CERT_ISSUED → CERT_EXPIRED ─────────────────────────────────────────────
  {
    ...
    to: "CERT_EXPIRED",
    by: ["ADMIN"],
    conditions: ["วันปัจจุบัน >= cert_expired_date"],
