<template>
  <div style="--v-theme-primary: var(--v-theme-export-user)">
      ...
      <v-list-item v-else nav class="py-4 px-4">
        <template v-slot:prepend>
          <div
            ...
            style="
              background: rgba(var(--v-theme-export-user), 0.12);
        ...
        <v-list-item-subtitle
          class="text-caption"
          style="color: rgb(var(--v-theme-export-user)); opacity: 0.85"
      ...
      <div v-if="!rail" class="px-4 mb-2">
        ...
        >
          ...
          <div class="flex-grow-1">
            <div
              class="text-body-2 font-weight-medium text-export-user"
              style="word-break: break-word; white-space: normal"
            >
            ...
            <div
              ...
              "
              class="text-caption text-export-user"
    ...
    <v-app-bar
      ...
      height="64"
      class="app-bar"
      :style="{ '--v-theme-primary': 'var(--v-theme-export-user)' }"
    >
      <v-btn
        icon="fas fa-bars"
        variant="text"
    ...
    <v-main class="bg-background">
      <v-container
        fluid
        class="pa-5 pa-md-7"
        style="max-width: 1320px; --v-theme-primary: var(--v-theme-export-user)"
      >
        <router-view />
      </v-container>
    </v-main>
...
<style scoped>
.user-avatar-md {
  background: rgba(var(--v-theme-export-user), 0.15);
