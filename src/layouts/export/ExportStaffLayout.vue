<template>
  <div style="--v-theme-primary: var(--v-theme-export-staff)">
    <v-navigation-drawer
      ...
      color="surface"
      class="app-sidebar"
      :style="{ '--v-theme-primary': 'var(--v-theme-export-staff)' }"
    >
      <v-list-item nav class="py-4 px-4">
        <template v-slot:prepend>
          <div
            ...
            style="
              background: rgba(var(--v-theme-export-staff), 0.12);
              border: 1px solid rgba(var(--v-theme-export-staff), 0.2);
            "
          >
        ...
        <v-list-item-subtitle
          class="text-caption"
          style="color: rgb(var(--v-theme-export-staff)); opacity: 0.85"
      ...
      <div v-if="!rail" class="px-4 mb-2">
        <div
          ...
          style="
            background: rgba(var(--v-theme-export-staff), 0.06);
            border: 1px solid rgba(var(--v-theme-export-staff), 0.12);
          "
        >
          ...
          <div class="flex-grow-1 overflow-hidden">
            <div
              class="text-truncate text-body-2 font-weight-medium text-export-staff"
            >
    ...
    <v-main class="bg-background">
      <v-container
        ...
        style="
          max-width: 1320px;
          --v-theme-primary: var(--v-theme-export-staff);
        "
      >
        <router-view />
      </v-container>
    ...
    items: [
      {
        ...
        to: "/export/staff/access-requests",
      },
      {
        title: "Masterdata",
        icon: "fas fa-table-list",
        to: "/export/staff/masterdata",
      },
    ],
  },
];
...
<style scoped>
.user-avatar-md {
  background: rgba(var(--v-theme-export-staff), 0.15);
  color: rgb(var(--v-theme-export-staff));
  width: 40px;
  height: 40px;
  border-radius: 50%;
  display: flex;
