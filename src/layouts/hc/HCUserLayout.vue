<template>
  <div style="--v-theme-primary: var(--v-theme-hc-user)">
    ...
    >
      ...
      <v-list v-if="rail" density="compact" nav class="px-2 py-2">
        <v-list-item rounded="lg" class="mb-1">
          <template v-slot>
            <v-icon icon="fas fa-virus" color="hc-user" size="20" />
          </template>
        </v-list-item>
      </v-list>
      ...
      <div v-if="!rail" class="px-4 mb-2">
        ...
        >
          ...
          <div class="flex-grow-1">
            <div
              class="text-body-2 font-weight-medium text-hc-user"
              style="word-break: break-word; white-space: normal"
            >
            ...
            <div
              ...
              "
              class="text-caption text-hc-user"
    ...
    <v-app-bar
      ...
      height="64"
      class="app-bar"
      :style="{ '--v-theme-primary': 'var(--v-theme-hc-user)' }"
    >
      <v-btn
        icon="fas fa-bars"
        variant="text"
    ...
    <v-main class="bg-background">
      <v-container
        fluid
        class="pa-5 pa-md-7"
        style="max-width: 1320px; --v-theme-primary: var(--v-theme-hc-user)"
      >
        <router-view />
      </v-container>
    </v-main>
