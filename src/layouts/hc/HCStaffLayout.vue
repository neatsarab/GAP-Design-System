<template>
  <div style="--v-theme-primary: var(--v-theme-hc-staff)">
        ...
        <template v-slot:prepend>
          <div
            ...
            style="
              ...
              border: 1px solid rgba(var(--v-theme-hc-staff), 0.2);
            "
          >
      ...
      <div v-if="!rail" class="px-4 mb-2">
        <div
          ...
          style="
            ...
            border: 1px solid rgba(var(--v-theme-hc-staff), 0.12);
          "
        >
    ...
    <v-app-bar
      ...
      height="64"
      class="app-bar"
      :style="{ '--v-theme-primary': 'var(--v-theme-hc-staff)' }"
    >
      <v-btn
        icon="fas fa-bars"
        variant="text"
    ...
    <v-main class="bg-background">
      <v-container
        fluid
        class="pa-5 pa-md-7"
        style="max-width: 1320px; --v-theme-primary: var(--v-theme-hc-staff)"
      >
        <router-view />
      </v-container>
    </v-main>
