    ...
    >
      <v-list-item nav class="py-4 px-4">
        ...
        <v-list-item-title
          ...
          >ระบบการรับรองมาตรฐานเกษตรอินทรีย์ (Organic
          Agriculture)</v-list-item-title
        >
        <v-list-item-subtitle
          class="text-caption"
          style="color: rgb(var(--v-theme-org-staff)); opacity: 0.85"
      ...
      <div v-if="!rail" class="px-4 mb-2">
        ...
        >
          ...
          <div class="flex-grow-1 overflow-hidden">
            <div
              class="text-truncate text-body-2 font-weight-medium text-org-staff"
            >
...
const breadcrumbs = computed(() => [
  {
    title: "ระบบการรับรองมาตรฐาน ORG (Organic Agriculture) พืช",
    to: "/org/staff",
  },
    ...
    items: [
      {
        ...
        to: "/org/staff/access-requests",
      },
      {
        title: "Masterdata",
        icon: "fas fa-table-list",
        to: "/org/staff/masterdata",
      },
    ],
  },
];
