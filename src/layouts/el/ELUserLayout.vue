<template>
  <div style="--v-theme-primary: var(--v-theme-el-user)">
    ...
    >
      ...
      <v-list-item v-else nav class="py-4 px-4">
        ...
        <v-list-item-title
          ...
          >ระบบการควบคุมพิเศษ Establishment List</v-list-item-title
        >
      ...
      <div v-if="!rail" class="px-4 mb-2">
        ...
        >
          ...
          <div class="flex-grow-1">
            <div
              class="text-body-2 font-weight-medium text-el-user"
              style="word-break: break-word; white-space: normal"
            >
            ...
            <div
              ...
              "
              class="text-caption text-el-user"
    ...
    <v-app-bar
      ...
      height="64"
      class="app-bar"
      :style="{ '--v-theme-primary': 'var(--v-theme-el-user)' }"
    >
      <v-btn
        icon="fas fa-bars"
        variant="text"
