<template>
  <div style="--v-theme-primary: var(--v-theme-el-user)">
    ...
    >
      ...
      <v-list-item nav class="py-4 px-4">
        <template v-slot:prepend>
          <div class="logo-icon-box rounded-lg mr-3" style="background: rgba(var(--v-theme-el-user), 0.12); border: 1px solid rgba(var(--v-theme-el-user), 0.2);">
      ...
      <div v-if="!rail" class="px-4 mb-2">
        <div class="user-card rounded-lg pa-3 d-flex align-center ga-2" style="background: rgba(var(--v-theme-el-user), 0.06); border: 1px solid rgba(var(--v-theme-el-user), 0.12);">
    ...
    <v-main class="bg-background">
      <v-container fluid class="pa-5 pa-md-7" style="max-width: 1320px; --v-theme-primary: var(--v-theme-el-user)">
        <router-view />
      </v-container>
    </v-main>
  </div>
