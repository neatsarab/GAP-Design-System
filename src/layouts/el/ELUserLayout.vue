<template>
    <div style="--v-theme-primary: var(--v-theme-el-user)">
        ...
        <v-navigation-drawer v-model="drawer" :rail="rail" permanent color="surface" class="app-sidebar">
            ...
            ">
                ...
                <v-list-item-title class="text-body-2 font-weight-bold"
                    style="word-break: break-word; white-space: normal">ระบบการควบคุมพิเศษ Establishment
                    List</v-list-item-title>
                <v-list-item-subtitle class="text-caption"
                    style="color: rgb(var(--v-theme-el-user)); opacity: 0.85">สำหรับผู้ประกอบการ</v-list-item-subtitle>
          ...
          ">
                    ...
                    <div class="flex-grow-1">
                        <div class="text-body-2 font-weight-medium text-el-user"
                            style="word-break: break-word; white-space: normal">
                            {{ sessionStore.displayName }}
                        </div>
                        <div v-if="
                            sessionStore.entityType === 'juristic' && sessionStore.taxId
                        " class="text-caption text-el-user" style="opacity: 0.75; word-break: break-word; white-space: normal">
            ...
            <v-list density="compact" nav class="mt-1 px-2">
                <template v-for="group in navGroups" :key="group.label">
                    ...
                    <v-list-item v-for="item in group.items" :key="item.to" :prepend-icon="item.icon"
                        :title="item.title" :to="item.to" active-color="el-user" rounded="lg" class="mb-1" />
        ...
        <!-- ── App Bar ── -->
        <v-app-bar flat height="64" class="app-bar" :style="{ '--v-theme-primary': 'var(--v-theme-el-user)' }">
            ...
            <div class="d-flex align-center ga-1 mr-3">
                ...
                <v-chip variant="outlined" color="el-user" class="user-chip mr-2 ml-1" prepend-icon="fas fa-user">
        ...
        <v-main class="bg-background">
            <v-container fluid class="pa-5 pa-md-7"
                style="max-width: 1320px; --v-theme-primary: var(--v-theme-el-user)">
                <router-view />
            </v-container>
        </v-main>
    </div>
...
const breadcrumbs = computed(() => [
    { title: "ระบบการควบคุมพิเศษ Establishment List", to: "/el/user" },
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                title: "ข้อมูลทะเบียน",
                icon: "fas fa-file-lines",
                to: "/el/user/registrationinfo",
            },
            {
                title: "ข้อมูลแปลงเกษตรกร",
                icon: "fas fa-file-lines",
                to: "/el/user/farmerplotinfo",
            },
        ],
    },
    {
...
<style scoped>
.user-avatar-md {
  background: rgba(var(--v-theme-el-user), 0.15);
