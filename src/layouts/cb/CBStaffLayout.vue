<template>
  <div style="--v-theme-primary: var(--v-theme-cb-staff)">
    <v-navigation-drawer
      ...
      color="surface"
      class="app-sidebar"
      :style="{ '--v-theme-primary': 'var(--v-theme-cb-staff)' }"
    >
      <v-list-item nav class="py-4 px-4">
        <template v-slot:prepend>
          <div
            ...
            style="
              background: rgba(var(--v-theme-cb-staff), 0.12);
              border: 1px solid rgba(var(--v-theme-cb-staff), 0.2);
            "
          >
        ...
        <v-list-item-subtitle
          class="text-caption"
          style="color: rgb(var(--v-theme-cb-staff)); opacity: 0.85"
      ...
      <div v-if="!rail" class="px-4 mb-2">
        <div
          ...
          style="
            background: rgba(var(--v-theme-cb-staff), 0.06);
            border: 1px solid rgba(var(--v-theme-cb-staff), 0.12);
          "
        >
    ...
    <v-main class="bg-background">
      <v-container
        fluid
        class="pa-5 pa-md-7"
        style="max-width: 1320px; --v-theme-primary: var(--v-theme-cb-staff)"
      >
        <router-view />
      </v-container>
    </v-main>
    ...
    items: [
      {
        ...
        to: "/cb/staff/access-requests",
      },
      {
        title: "Masterdata",
        icon: "fas fa-table-list",
        to: "/cb/staff/masterdata",
      },
    ],
  },
];
