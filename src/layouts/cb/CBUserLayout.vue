<template>
  <div style="--v-theme-primary: var(--v-theme-cb-user)">
    ...
    >
      ...
      <v-list-item v-else nav class="py-4 px-4">
        <template v-slot:prepend>
          <div
            ...
            style="
              ...
              border: 1px solid rgba(var(--v-theme-cb-user), 0.2);
            "
          >
            <v-icon icon="fas fa-certificate" color="cb-user" size="20" />
          </div>
        ...
        <v-list-item-subtitle
          class="text-caption"
          style="color: rgb(var(--v-theme-cb-user)); opacity: 0.85"
      ...
      <div v-if="!rail" class="px-4 mb-2">
        <div
          ...
          style="
            background: rgba(var(--v-theme-cb-user), 0.06);
            border: 1px solid rgba(var(--v-theme-cb-user), 0.12);
          "
        >
          ...
          <div class="flex-grow-1">
            <div
              class="text-body-2 font-weight-medium text-cb-user"
              style="word-break: break-word; white-space: normal"
            >
            ...
            <div
              ...
              "
              class="text-caption text-cb-user"
    ...
    <v-app-bar
      ...
      height="64"
      class="app-bar"
      :style="{ '--v-theme-primary': 'var(--v-theme-cb-user)' }"
    >
      <v-btn
        icon="fas fa-bars"
        variant="text"
    ...
    <v-main class="bg-background">
      <v-container
        fluid
        class="pa-5 pa-md-7"
        style="max-width: 1320px; --v-theme-primary: var(--v-theme-cb-user)"
      >
        <router-view />
      </v-container>
    </v-main>
...
const breadcrumbs = computed(() => [
  { title: "ระบบการขึ้นทะเบียนหน่วยรับรองโรงงานผลิตสินค้าพืช", to: "/cb/user" },
...
<style scoped>
.user-avatar-md {
  background: rgba(var(--v-theme-cb-user), 0.15);
  color: rgb(var(--v-theme-cb-user));
}
</style>
