...
.logo-icon-box { width: 36px; height: 36px; background: rgba(var(--v-theme-cb-user), 0.12); border: 1px solid rgba(var(--v-theme-cb-user), 0.2); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.user-card { background: rgba(var(--v-theme-cb-user), 0.06); border: 1px solid rgba(var(--v-theme-cb-user), 0.12); }
...
.user-chip { font-size: 12px; background: rgba(var(--v-theme-cb-user), 0.06); }
