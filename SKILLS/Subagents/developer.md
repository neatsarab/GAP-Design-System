...
## บทบาท
นักพัฒนา Frontend ผู้รับผิดชอบการเขียนโค้ด Vue 3 + Vuetify 3 สำหรับระบบรับรองแหล่งผลิต GAP พืช ครอบคลุมตั้งแต่การสร้าง Component, Store, Router จนถึงการเชื่อมต่อ API
